...
func NewDiscoveryEngineSchema(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/discoveryEngineSchema:DiscoveryEngineSchema", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryEngineSchema(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/discoveryEngineSchema:DiscoveryEngineSchema", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
