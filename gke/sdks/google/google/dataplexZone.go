...
func NewDataplexZone(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexZone:DataplexZone", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexZone(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexZone:DataplexZone", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
