...
func NewAccessContextManagerAccessPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerAccessPolicyIamBinding:AccessContextManagerAccessPolicyIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerAccessPolicyIamBinding:AccessContextManagerAccessPolicyIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
