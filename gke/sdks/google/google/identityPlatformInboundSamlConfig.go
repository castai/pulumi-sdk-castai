...
func NewIdentityPlatformInboundSamlConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/identityPlatformInboundSamlConfig:IdentityPlatformInboundSamlConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformInboundSamlConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/identityPlatformInboundSamlConfig:IdentityPlatformInboundSamlConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
