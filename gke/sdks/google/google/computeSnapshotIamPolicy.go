...
func NewComputeSnapshotIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSnapshotIamPolicy:ComputeSnapshotIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSnapshotIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSnapshotIamPolicy:ComputeSnapshotIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
