...
func NewDocumentAiProcessorDefaultVersion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/documentAiProcessorDefaultVersion:DocumentAiProcessorDefaultVersion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDocumentAiProcessorDefaultVersion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/documentAiProcessorDefaultVersion:DocumentAiProcessorDefaultVersion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
