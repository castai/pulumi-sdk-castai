...
func NewComputeInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeInstanceIamPolicy:ComputeInstanceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeInstanceIamPolicy:ComputeInstanceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
