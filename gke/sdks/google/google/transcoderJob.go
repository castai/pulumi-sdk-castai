...
func NewTranscoderJob(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/transcoderJob:TranscoderJob", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTranscoderJob(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/transcoderJob:TranscoderJob", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
