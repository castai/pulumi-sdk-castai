...
func NewDataLossPreventionDiscoveryConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataLossPreventionDiscoveryConfig:DataLossPreventionDiscoveryConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataLossPreventionDiscoveryConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataLossPreventionDiscoveryConfig:DataLossPreventionDiscoveryConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
