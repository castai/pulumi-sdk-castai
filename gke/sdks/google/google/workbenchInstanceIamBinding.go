...
func NewWorkbenchInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/workbenchInstanceIamBinding:WorkbenchInstanceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbenchInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/workbenchInstanceIamBinding:WorkbenchInstanceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
