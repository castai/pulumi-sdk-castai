...
func NewContainerAnalysisNote(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/containerAnalysisNote:ContainerAnalysisNote", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAnalysisNote(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/containerAnalysisNote:ContainerAnalysisNote", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
