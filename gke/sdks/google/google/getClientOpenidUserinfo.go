...
func GetClientOpenidUserinfo(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetClientOpenidUserinfoResult, error) {
	...
	err = ctx.InvokePackage("google:index/getClientOpenidUserinfo:getClientOpenidUserinfo", nil, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetClientOpenidUserinfoOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetClientOpenidUserinfoResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetClientOpenidUserinfoResultOutput, error) {
		...
		return ctx.InvokeOutput("google:index/getClientOpenidUserinfo:getClientOpenidUserinfo", nil, GetClientOpenidUserinfoResultOutput{}, options).(GetClientOpenidUserinfoResultOutput), nil
