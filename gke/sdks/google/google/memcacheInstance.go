...
func NewMemcacheInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/memcacheInstance:MemcacheInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMemcacheInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/memcacheInstance:MemcacheInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
