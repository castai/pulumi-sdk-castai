...
func NewComputeFirewallPolicyRule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeFirewallPolicyRule:ComputeFirewallPolicyRule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeFirewallPolicyRule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeFirewallPolicyRule:ComputeFirewallPolicyRule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
