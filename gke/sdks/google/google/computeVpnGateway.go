...
func NewComputeVpnGateway(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeVpnGateway:ComputeVpnGateway", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeVpnGateway(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeVpnGateway:ComputeVpnGateway", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
