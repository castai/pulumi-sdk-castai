...
func NewDataCatalogEntryGroupIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataCatalogEntryGroupIamBinding:DataCatalogEntryGroupIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogEntryGroupIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataCatalogEntryGroupIamBinding:DataCatalogEntryGroupIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
