...
func NewSourcerepoRepository(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sourcerepoRepository:SourcerepoRepository", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourcerepoRepository(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sourcerepoRepository:SourcerepoRepository", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
