...
func NewEventarcTrigger(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/eventarcTrigger:EventarcTrigger", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventarcTrigger(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/eventarcTrigger:EventarcTrigger", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
