...
type Project struct {
	...
	GoogleProjectId pulumi.StringOutput    `pulumi:"googleProjectId"`
...
func NewProject(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/project:Project", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/project:Project", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ProjectOutput) GoogleProjectId() pulumi.StringOutput {
	return o.ApplyT(func(v *Project) pulumi.StringOutput { return v.GoogleProjectId }).(pulumi.StringOutput)
}
