...
func NewFilestoreSnapshot(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/filestoreSnapshot:FilestoreSnapshot", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilestoreSnapshot(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/filestoreSnapshot:FilestoreSnapshot", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
