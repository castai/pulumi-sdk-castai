...
func NewComputeInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeInstanceIamBinding:ComputeInstanceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeInstanceIamBinding:ComputeInstanceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
