...
func NewAlloydbCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/alloydbCluster:AlloydbCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlloydbCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/alloydbCluster:AlloydbCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
