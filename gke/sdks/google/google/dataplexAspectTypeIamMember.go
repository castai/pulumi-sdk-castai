...
func NewDataplexAspectTypeIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexAspectTypeIamMember:DataplexAspectTypeIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAspectTypeIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexAspectTypeIamMember:DataplexAspectTypeIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
