...
func NewDataplexTaskIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexTaskIamBinding:DataplexTaskIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexTaskIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexTaskIamBinding:DataplexTaskIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
