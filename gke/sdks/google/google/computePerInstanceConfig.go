...
func NewComputePerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computePerInstanceConfig:ComputePerInstanceConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputePerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computePerInstanceConfig:ComputePerInstanceConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
