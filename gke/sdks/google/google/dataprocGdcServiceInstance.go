...
func NewDataprocGdcServiceInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocGdcServiceInstance:DataprocGdcServiceInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocGdcServiceInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocGdcServiceInstance:DataprocGdcServiceInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
