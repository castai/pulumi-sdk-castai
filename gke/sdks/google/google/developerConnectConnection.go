...
func NewDeveloperConnectConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/developerConnectConnection:DeveloperConnectConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeveloperConnectConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/developerConnectConnection:DeveloperConnectConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
