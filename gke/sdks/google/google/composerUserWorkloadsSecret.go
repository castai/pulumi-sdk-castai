...
func NewComposerUserWorkloadsSecret(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/composerUserWorkloadsSecret:ComposerUserWorkloadsSecret", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComposerUserWorkloadsSecret(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/composerUserWorkloadsSecret:ComposerUserWorkloadsSecret", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
