...
func NewDataprocWorkflowTemplate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocWorkflowTemplate:DataprocWorkflowTemplate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocWorkflowTemplate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocWorkflowTemplate:DataprocWorkflowTemplate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
