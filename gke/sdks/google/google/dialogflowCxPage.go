...
func NewDialogflowCxPage(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxPage:DialogflowCxPage", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxPage(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxPage:DialogflowCxPage", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
