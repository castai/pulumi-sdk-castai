...
func NewComputeImageIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeImageIamMember:ComputeImageIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeImageIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeImageIamMember:ComputeImageIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
