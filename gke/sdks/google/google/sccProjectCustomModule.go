...
func NewSccProjectCustomModule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccProjectCustomModule:SccProjectCustomModule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccProjectCustomModule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccProjectCustomModule:SccProjectCustomModule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
