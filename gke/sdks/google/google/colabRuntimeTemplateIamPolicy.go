...
func NewColabRuntimeTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/colabRuntimeTemplateIamPolicy:ColabRuntimeTemplateIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabRuntimeTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/colabRuntimeTemplateIamPolicy:ColabRuntimeTemplateIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
