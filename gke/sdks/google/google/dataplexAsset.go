...
func NewDataplexAsset(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexAsset:DataplexAsset", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAsset(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexAsset:DataplexAsset", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
