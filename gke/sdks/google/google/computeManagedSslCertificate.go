...
func NewComputeManagedSslCertificate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeManagedSslCertificate:ComputeManagedSslCertificate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeManagedSslCertificate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeManagedSslCertificate:ComputeManagedSslCertificate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
