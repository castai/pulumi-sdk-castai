...
func NewArtifactRegistryRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/artifactRegistryRepositoryIamMember:ArtifactRegistryRepositoryIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactRegistryRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/artifactRegistryRepositoryIamMember:ArtifactRegistryRepositoryIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
