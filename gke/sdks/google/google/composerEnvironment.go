...
func NewComposerEnvironment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/composerEnvironment:ComposerEnvironment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComposerEnvironment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/composerEnvironment:ComposerEnvironment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
