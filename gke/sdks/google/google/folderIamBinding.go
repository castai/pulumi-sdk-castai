...
func NewFolderIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/folderIamBinding:FolderIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/folderIamBinding:FolderIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
