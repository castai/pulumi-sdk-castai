...
func NewWorkbenchInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/workbenchInstanceIamPolicy:WorkbenchInstanceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkbenchInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/workbenchInstanceIamPolicy:WorkbenchInstanceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
