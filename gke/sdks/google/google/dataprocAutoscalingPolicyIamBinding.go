...
func NewDataprocAutoscalingPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocAutoscalingPolicyIamBinding:DataprocAutoscalingPolicyIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocAutoscalingPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocAutoscalingPolicyIamBinding:DataprocAutoscalingPolicyIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
