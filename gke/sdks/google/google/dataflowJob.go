...
func NewDataflowJob(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataflowJob:DataflowJob", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataflowJob(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataflowJob:DataflowJob", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
