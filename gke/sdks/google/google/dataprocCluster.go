...
func NewDataprocCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocCluster:DataprocCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocCluster:DataprocCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
