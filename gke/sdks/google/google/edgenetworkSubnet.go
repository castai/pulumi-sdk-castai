...
func NewEdgenetworkSubnet(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/edgenetworkSubnet:EdgenetworkSubnet", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgenetworkSubnet(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/edgenetworkSubnet:EdgenetworkSubnet", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
