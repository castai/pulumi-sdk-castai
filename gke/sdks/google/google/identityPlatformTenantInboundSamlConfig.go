...
func NewIdentityPlatformTenantInboundSamlConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/identityPlatformTenantInboundSamlConfig:IdentityPlatformTenantInboundSamlConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformTenantInboundSamlConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/identityPlatformTenantInboundSamlConfig:IdentityPlatformTenantInboundSamlConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
