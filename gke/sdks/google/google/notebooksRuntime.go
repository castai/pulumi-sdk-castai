...
func NewNotebooksRuntime(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/notebooksRuntime:NotebooksRuntime", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksRuntime(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/notebooksRuntime:NotebooksRuntime", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
