...
func NewVmwareengineNetwork(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vmwareengineNetwork:VmwareengineNetwork", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareengineNetwork(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vmwareengineNetwork:VmwareengineNetwork", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
