...
func NewStorageHmacKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageHmacKey:StorageHmacKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageHmacKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageHmacKey:StorageHmacKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
