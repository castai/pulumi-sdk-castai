...
func NewCloudRunServiceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudRunServiceIamBinding:CloudRunServiceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunServiceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudRunServiceIamBinding:CloudRunServiceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
