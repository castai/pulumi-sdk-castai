...
func NewSccMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccMuteConfig:SccMuteConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccMuteConfig:SccMuteConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
