...
func NewDialogflowCxVersion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxVersion:DialogflowCxVersion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxVersion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxVersion:DialogflowCxVersion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
