...
func NewVertexAiEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiEndpoint:VertexAiEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiEndpoint:VertexAiEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
