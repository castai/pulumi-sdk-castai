...
func NewStorageDefaultObjectAcl(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageDefaultObjectAcl:StorageDefaultObjectAcl", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageDefaultObjectAcl(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageDefaultObjectAcl:StorageDefaultObjectAcl", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
