...
func NewNetappVolume(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/netappVolume:NetappVolume", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappVolume(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/netappVolume:NetappVolume", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
