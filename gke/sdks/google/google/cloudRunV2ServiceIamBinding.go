...
func NewCloudRunV2ServiceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudRunV2ServiceIamBinding:CloudRunV2ServiceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunV2ServiceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudRunV2ServiceIamBinding:CloudRunV2ServiceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
