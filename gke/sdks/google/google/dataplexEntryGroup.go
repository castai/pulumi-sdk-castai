...
func NewDataplexEntryGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexEntryGroup:DataplexEntryGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexEntryGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexEntryGroup:DataplexEntryGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
