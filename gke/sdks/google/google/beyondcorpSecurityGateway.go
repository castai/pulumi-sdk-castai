...
func NewBeyondcorpSecurityGateway(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/beyondcorpSecurityGateway:BeyondcorpSecurityGateway", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpSecurityGateway(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/beyondcorpSecurityGateway:BeyondcorpSecurityGateway", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
