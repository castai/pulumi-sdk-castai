...
func NewNetworkConnectivitySpoke(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkConnectivitySpoke:NetworkConnectivitySpoke", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivitySpoke(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkConnectivitySpoke:NetworkConnectivitySpoke", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
