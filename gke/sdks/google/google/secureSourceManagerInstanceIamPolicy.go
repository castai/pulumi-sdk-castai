...
func NewSecureSourceManagerInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secureSourceManagerInstanceIamPolicy:SecureSourceManagerInstanceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecureSourceManagerInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secureSourceManagerInstanceIamPolicy:SecureSourceManagerInstanceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
