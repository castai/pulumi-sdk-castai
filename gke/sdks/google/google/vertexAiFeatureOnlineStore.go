...
func NewVertexAiFeatureOnlineStore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiFeatureOnlineStore:VertexAiFeatureOnlineStore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeatureOnlineStore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiFeatureOnlineStore:VertexAiFeatureOnlineStore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
