...
func NewComputeRouterNat(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRouterNat:ComputeRouterNat", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRouterNat(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRouterNat:ComputeRouterNat", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
