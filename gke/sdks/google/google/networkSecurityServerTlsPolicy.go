...
func NewNetworkSecurityServerTlsPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkSecurityServerTlsPolicy:NetworkSecurityServerTlsPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityServerTlsPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkSecurityServerTlsPolicy:NetworkSecurityServerTlsPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
