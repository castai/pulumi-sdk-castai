...
func NewDataCatalogTagTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataCatalogTagTemplateIamBinding:DataCatalogTagTemplateIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogTagTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataCatalogTagTemplateIamBinding:DataCatalogTagTemplateIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
