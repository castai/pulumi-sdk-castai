...
func NewComputeSslPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSslPolicy:ComputeSslPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSslPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSslPolicy:ComputeSslPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
