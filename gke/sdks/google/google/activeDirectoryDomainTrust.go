...
func NewActiveDirectoryDomainTrust(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/activeDirectoryDomainTrust:ActiveDirectoryDomainTrust", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActiveDirectoryDomainTrust(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/activeDirectoryDomainTrust:ActiveDirectoryDomainTrust", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
