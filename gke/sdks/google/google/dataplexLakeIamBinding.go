...
func NewDataplexLakeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexLakeIamBinding:DataplexLakeIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexLakeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexLakeIamBinding:DataplexLakeIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
