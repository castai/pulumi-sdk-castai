...
func NewColabRuntimeTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/colabRuntimeTemplateIamBinding:ColabRuntimeTemplateIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabRuntimeTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/colabRuntimeTemplateIamBinding:ColabRuntimeTemplateIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
