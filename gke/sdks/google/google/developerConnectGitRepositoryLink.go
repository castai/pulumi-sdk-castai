...
func NewDeveloperConnectGitRepositoryLink(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/developerConnectGitRepositoryLink:DeveloperConnectGitRepositoryLink", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeveloperConnectGitRepositoryLink(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/developerConnectGitRepositoryLink:DeveloperConnectGitRepositoryLink", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
