...
func NewSpannerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerInstanceConfig:SpannerInstanceConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerInstanceConfig:SpannerInstanceConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
