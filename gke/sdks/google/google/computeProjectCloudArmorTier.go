...
func NewComputeProjectCloudArmorTier(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeProjectCloudArmorTier:ComputeProjectCloudArmorTier", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeProjectCloudArmorTier(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeProjectCloudArmorTier:ComputeProjectCloudArmorTier", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
