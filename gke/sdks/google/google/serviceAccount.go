...
func NewServiceAccount(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/serviceAccount:ServiceAccount", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccount(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/serviceAccount:ServiceAccount", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
