...
func NewCloudfunctionsFunctionIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudfunctionsFunctionIamMember:CloudfunctionsFunctionIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudfunctionsFunctionIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudfunctionsFunctionIamMember:CloudfunctionsFunctionIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
