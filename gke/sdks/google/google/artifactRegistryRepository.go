...
func NewArtifactRegistryRepository(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/artifactRegistryRepository:ArtifactRegistryRepository", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactRegistryRepository(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/artifactRegistryRepository:ArtifactRegistryRepository", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
