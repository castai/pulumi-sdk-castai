...
func NewEventarcGoogleChannelConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/eventarcGoogleChannelConfig:EventarcGoogleChannelConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventarcGoogleChannelConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/eventarcGoogleChannelConfig:EventarcGoogleChannelConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
