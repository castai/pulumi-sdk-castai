...
func NewCloudfunctions2Function(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudfunctions2Function:Cloudfunctions2Function", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudfunctions2Function(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudfunctions2Function:Cloudfunctions2Function", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
