...
func NewComputeRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionTargetHttpProxy:ComputeRegionTargetHttpProxy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionTargetHttpProxy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionTargetHttpProxy:ComputeRegionTargetHttpProxy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
