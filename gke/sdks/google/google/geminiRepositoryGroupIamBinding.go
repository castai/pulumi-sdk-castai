...
func NewGeminiRepositoryGroupIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/geminiRepositoryGroupIamBinding:GeminiRepositoryGroupIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGeminiRepositoryGroupIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/geminiRepositoryGroupIamBinding:GeminiRepositoryGroupIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
