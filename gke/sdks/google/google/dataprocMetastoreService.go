...
func NewDataprocMetastoreService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocMetastoreService:DataprocMetastoreService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocMetastoreService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocMetastoreService:DataprocMetastoreService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
