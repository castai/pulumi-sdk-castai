...
func NewFirebaserulesRuleset(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/firebaserulesRuleset:FirebaserulesRuleset", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaserulesRuleset(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/firebaserulesRuleset:FirebaserulesRuleset", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
