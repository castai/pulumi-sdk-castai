...
func NewHealthcareConsentStore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/healthcareConsentStore:HealthcareConsentStore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareConsentStore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/healthcareConsentStore:HealthcareConsentStore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
