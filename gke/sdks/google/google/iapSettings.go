...
func NewIapSettings(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapSettings:IapSettings", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapSettings(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapSettings:IapSettings", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
