...
func NewNetworkServicesAuthzExtension(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkServicesAuthzExtension:NetworkServicesAuthzExtension", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServicesAuthzExtension(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkServicesAuthzExtension:NetworkServicesAuthzExtension", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
