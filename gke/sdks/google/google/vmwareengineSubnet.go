...
func NewVmwareengineSubnet(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vmwareengineSubnet:VmwareengineSubnet", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareengineSubnet(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vmwareengineSubnet:VmwareengineSubnet", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
