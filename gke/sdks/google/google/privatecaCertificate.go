...
func NewPrivatecaCertificate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/privatecaCertificate:PrivatecaCertificate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivatecaCertificate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/privatecaCertificate:PrivatecaCertificate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
