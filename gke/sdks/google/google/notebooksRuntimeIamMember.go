...
func NewNotebooksRuntimeIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/notebooksRuntimeIamMember:NotebooksRuntimeIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksRuntimeIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/notebooksRuntimeIamMember:NotebooksRuntimeIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
