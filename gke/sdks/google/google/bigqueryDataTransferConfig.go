...
func NewBigqueryDataTransferConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDataTransferConfig:BigqueryDataTransferConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDataTransferConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDataTransferConfig:BigqueryDataTransferConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
