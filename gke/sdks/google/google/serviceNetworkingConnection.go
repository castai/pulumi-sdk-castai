...
func NewServiceNetworkingConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/serviceNetworkingConnection:ServiceNetworkingConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceNetworkingConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/serviceNetworkingConnection:ServiceNetworkingConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
