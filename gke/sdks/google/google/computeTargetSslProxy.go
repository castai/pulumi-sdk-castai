...
func NewComputeTargetSslProxy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeTargetSslProxy:ComputeTargetSslProxy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeTargetSslProxy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeTargetSslProxy:ComputeTargetSslProxy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
