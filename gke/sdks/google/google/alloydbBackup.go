...
func NewAlloydbBackup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/alloydbBackup:AlloydbBackup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlloydbBackup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/alloydbBackup:AlloydbBackup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
