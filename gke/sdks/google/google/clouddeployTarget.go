...
func NewClouddeployTarget(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/clouddeployTarget:ClouddeployTarget", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddeployTarget(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/clouddeployTarget:ClouddeployTarget", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
