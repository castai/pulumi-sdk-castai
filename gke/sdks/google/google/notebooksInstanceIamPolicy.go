...
func NewNotebooksInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/notebooksInstanceIamPolicy:NotebooksInstanceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/notebooksInstanceIamPolicy:NotebooksInstanceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
