...
func NewComputeRegionBackendService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionBackendService:ComputeRegionBackendService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionBackendService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionBackendService:ComputeRegionBackendService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
