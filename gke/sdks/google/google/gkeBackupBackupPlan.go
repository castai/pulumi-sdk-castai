...
func NewGkeBackupBackupPlan(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/gkeBackupBackupPlan:GkeBackupBackupPlan", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeBackupBackupPlan(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/gkeBackupBackupPlan:GkeBackupBackupPlan", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
