...
func NewFolderAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/folderAccessApprovalSettings:FolderAccessApprovalSettings", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/folderAccessApprovalSettings:FolderAccessApprovalSettings", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
