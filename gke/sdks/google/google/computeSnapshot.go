...
func NewComputeSnapshot(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSnapshot:ComputeSnapshot", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSnapshot(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSnapshot:ComputeSnapshot", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
