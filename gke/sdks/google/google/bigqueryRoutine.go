...
func NewBigqueryRoutine(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryRoutine:BigqueryRoutine", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryRoutine(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryRoutine:BigqueryRoutine", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
