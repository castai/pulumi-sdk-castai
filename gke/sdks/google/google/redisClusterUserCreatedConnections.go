...
func NewRedisClusterUserCreatedConnections(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/redisClusterUserCreatedConnections:RedisClusterUserCreatedConnections", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisClusterUserCreatedConnections(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/redisClusterUserCreatedConnections:RedisClusterUserCreatedConnections", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
