...
func NewMonitoringDashboard(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/monitoringDashboard:MonitoringDashboard", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringDashboard(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/monitoringDashboard:MonitoringDashboard", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
