...
func NewComputeInstanceSettings(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeInstanceSettings:ComputeInstanceSettings", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeInstanceSettings(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeInstanceSettings:ComputeInstanceSettings", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
