...
func NewEndpointsServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/endpointsServiceIamMember:EndpointsServiceIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointsServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/endpointsServiceIamMember:EndpointsServiceIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
