...
func NewStorageDefaultObjectAccessControl(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageDefaultObjectAccessControl:StorageDefaultObjectAccessControl", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageDefaultObjectAccessControl(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageDefaultObjectAccessControl:StorageDefaultObjectAccessControl", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
