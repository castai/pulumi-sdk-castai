...
func NewKmsKeyRingIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/kmsKeyRingIamPolicy:KmsKeyRingIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsKeyRingIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/kmsKeyRingIamPolicy:KmsKeyRingIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
