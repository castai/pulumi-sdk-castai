...
func NewEdgecontainerCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/edgecontainerCluster:EdgecontainerCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgecontainerCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/edgecontainerCluster:EdgecontainerCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
