...
func NewVertexAiFeaturestoreEntitytypeFeature(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiFeaturestoreEntitytypeFeature:VertexAiFeaturestoreEntitytypeFeature", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeaturestoreEntitytypeFeature(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiFeaturestoreEntitytypeFeature:VertexAiFeaturestoreEntitytypeFeature", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
