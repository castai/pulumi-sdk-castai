...
func NewIdentityPlatformTenantOauthIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/identityPlatformTenantOauthIdpConfig:IdentityPlatformTenantOauthIdpConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformTenantOauthIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/identityPlatformTenantOauthIdpConfig:IdentityPlatformTenantOauthIdpConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
