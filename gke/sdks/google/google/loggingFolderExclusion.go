...
func NewLoggingFolderExclusion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/loggingFolderExclusion:LoggingFolderExclusion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingFolderExclusion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/loggingFolderExclusion:LoggingFolderExclusion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
