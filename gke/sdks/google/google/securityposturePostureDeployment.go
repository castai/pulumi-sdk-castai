...
func NewSecurityposturePostureDeployment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/securityposturePostureDeployment:SecurityposturePostureDeployment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityposturePostureDeployment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/securityposturePostureDeployment:SecurityposturePostureDeployment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
