...
func NewIamAccessBoundaryPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iamAccessBoundaryPolicy:IamAccessBoundaryPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamAccessBoundaryPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iamAccessBoundaryPolicy:IamAccessBoundaryPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
