...
func NewComputeRegionTargetTcpProxy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionTargetTcpProxy:ComputeRegionTargetTcpProxy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionTargetTcpProxy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionTargetTcpProxy:ComputeRegionTargetTcpProxy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
