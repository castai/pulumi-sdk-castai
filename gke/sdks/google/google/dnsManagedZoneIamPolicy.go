...
func NewDnsManagedZoneIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dnsManagedZoneIamPolicy:DnsManagedZoneIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsManagedZoneIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dnsManagedZoneIamPolicy:DnsManagedZoneIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
