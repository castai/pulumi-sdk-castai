...
func NewDataplexAspectTypeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexAspectTypeIamBinding:DataplexAspectTypeIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAspectTypeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexAspectTypeIamBinding:DataplexAspectTypeIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
