...
func NewDnsManagedZoneIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dnsManagedZoneIamBinding:DnsManagedZoneIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsManagedZoneIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dnsManagedZoneIamBinding:DnsManagedZoneIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
