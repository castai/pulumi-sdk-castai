...
func NewBigtableTable(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigtableTable:BigtableTable", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigtableTable(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigtableTable:BigtableTable", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
