...
func NewVertexAiDataset(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiDataset:VertexAiDataset", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiDataset(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiDataset:VertexAiDataset", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
