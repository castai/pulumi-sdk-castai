...
func NewDataprocMetastoreFederationIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocMetastoreFederationIamPolicy:DataprocMetastoreFederationIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocMetastoreFederationIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocMetastoreFederationIamPolicy:DataprocMetastoreFederationIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
