...
func NewComputeSnapshotIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSnapshotIamBinding:ComputeSnapshotIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSnapshotIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSnapshotIamBinding:ComputeSnapshotIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
