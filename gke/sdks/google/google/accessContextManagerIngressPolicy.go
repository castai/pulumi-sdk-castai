...
func NewAccessContextManagerIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerIngressPolicy:AccessContextManagerIngressPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerIngressPolicy:AccessContextManagerIngressPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
