...
func NewDialogflowCxEnvironment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxEnvironment:DialogflowCxEnvironment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxEnvironment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxEnvironment:DialogflowCxEnvironment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
