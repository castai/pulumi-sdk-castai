...
func NewBigqueryDatasetIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDatasetIamBinding:BigqueryDatasetIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatasetIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDatasetIamBinding:BigqueryDatasetIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
