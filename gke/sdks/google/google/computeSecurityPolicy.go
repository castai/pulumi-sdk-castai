...
func NewComputeSecurityPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSecurityPolicy:ComputeSecurityPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSecurityPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSecurityPolicy:ComputeSecurityPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
