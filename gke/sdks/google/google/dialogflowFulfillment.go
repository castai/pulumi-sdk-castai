...
func NewDialogflowFulfillment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowFulfillment:DialogflowFulfillment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowFulfillment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowFulfillment:DialogflowFulfillment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
