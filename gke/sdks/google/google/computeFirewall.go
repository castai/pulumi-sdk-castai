...
func NewComputeFirewall(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeFirewall:ComputeFirewall", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeFirewall(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeFirewall:ComputeFirewall", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
