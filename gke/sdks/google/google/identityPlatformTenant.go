...
func NewIdentityPlatformTenant(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/identityPlatformTenant:IdentityPlatformTenant", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformTenant(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/identityPlatformTenant:IdentityPlatformTenant", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
