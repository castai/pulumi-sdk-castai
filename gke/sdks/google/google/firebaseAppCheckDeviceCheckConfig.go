...
func NewFirebaseAppCheckDeviceCheckConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/firebaseAppCheckDeviceCheckConfig:FirebaseAppCheckDeviceCheckConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckDeviceCheckConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/firebaseAppCheckDeviceCheckConfig:FirebaseAppCheckDeviceCheckConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
