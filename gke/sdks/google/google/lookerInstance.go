...
func NewLookerInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/lookerInstance:LookerInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLookerInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/lookerInstance:LookerInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
