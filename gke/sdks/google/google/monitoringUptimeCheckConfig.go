...
func NewMonitoringUptimeCheckConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/monitoringUptimeCheckConfig:MonitoringUptimeCheckConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringUptimeCheckConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/monitoringUptimeCheckConfig:MonitoringUptimeCheckConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
