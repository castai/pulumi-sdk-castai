...
func NewNetworkManagementVpcFlowLogsConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkManagementVpcFlowLogsConfig:NetworkManagementVpcFlowLogsConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkManagementVpcFlowLogsConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkManagementVpcFlowLogsConfig:NetworkManagementVpcFlowLogsConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
