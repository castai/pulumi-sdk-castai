...
func NewServiceAccountIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/serviceAccountIamPolicy:ServiceAccountIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/serviceAccountIamPolicy:ServiceAccountIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
