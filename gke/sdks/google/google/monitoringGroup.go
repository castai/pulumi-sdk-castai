...
func NewMonitoringGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/monitoringGroup:MonitoringGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/monitoringGroup:MonitoringGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
