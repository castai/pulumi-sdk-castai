...
func NewCloudfunctions2FunctionIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudfunctions2FunctionIamMember:Cloudfunctions2FunctionIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudfunctions2FunctionIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudfunctions2FunctionIamMember:Cloudfunctions2FunctionIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
