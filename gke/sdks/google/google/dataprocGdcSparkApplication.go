...
func NewDataprocGdcSparkApplication(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocGdcSparkApplication:DataprocGdcSparkApplication", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocGdcSparkApplication(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocGdcSparkApplication:DataprocGdcSparkApplication", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
