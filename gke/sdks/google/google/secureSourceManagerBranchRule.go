...
func NewSecureSourceManagerBranchRule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secureSourceManagerBranchRule:SecureSourceManagerBranchRule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecureSourceManagerBranchRule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secureSourceManagerBranchRule:SecureSourceManagerBranchRule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
