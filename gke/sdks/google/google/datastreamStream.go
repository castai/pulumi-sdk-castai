...
func NewDatastreamStream(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/datastreamStream:DatastreamStream", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastreamStream(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/datastreamStream:DatastreamStream", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
