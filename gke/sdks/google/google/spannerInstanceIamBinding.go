...
func NewSpannerInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerInstanceIamBinding:SpannerInstanceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerInstanceIamBinding:SpannerInstanceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
