...
func NewIapWebRegionBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapWebRegionBackendServiceIamPolicy:IapWebRegionBackendServiceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapWebRegionBackendServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapWebRegionBackendServiceIamPolicy:IapWebRegionBackendServiceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
