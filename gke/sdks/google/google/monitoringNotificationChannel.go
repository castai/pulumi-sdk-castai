...
func NewMonitoringNotificationChannel(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/monitoringNotificationChannel:MonitoringNotificationChannel", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringNotificationChannel(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/monitoringNotificationChannel:MonitoringNotificationChannel", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
