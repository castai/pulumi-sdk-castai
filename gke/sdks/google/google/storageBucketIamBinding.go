...
func NewStorageBucketIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageBucketIamBinding:StorageBucketIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageBucketIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageBucketIamBinding:StorageBucketIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
