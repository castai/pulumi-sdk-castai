...
func NewVmwareengineCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vmwareengineCluster:VmwareengineCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareengineCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vmwareengineCluster:VmwareengineCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
