...
func NewIntegrationConnectorsConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/integrationConnectorsConnection:IntegrationConnectorsConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationConnectorsConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/integrationConnectorsConnection:IntegrationConnectorsConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
