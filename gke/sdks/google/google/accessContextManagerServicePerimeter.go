...
func NewAccessContextManagerServicePerimeter(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerServicePerimeter:AccessContextManagerServicePerimeter", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeter(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerServicePerimeter:AccessContextManagerServicePerimeter", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
