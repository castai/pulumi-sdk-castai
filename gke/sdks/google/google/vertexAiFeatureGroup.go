...
func NewVertexAiFeatureGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiFeatureGroup:VertexAiFeatureGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeatureGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiFeatureGroup:VertexAiFeatureGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
