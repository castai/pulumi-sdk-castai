...
func NewSccSourceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccSourceIamBinding:SccSourceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccSourceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccSourceIamBinding:SccSourceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
