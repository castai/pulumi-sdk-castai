...
func NewNetworkManagementConnectivityTest(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkManagementConnectivityTest:NetworkManagementConnectivityTest", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkManagementConnectivityTest(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkManagementConnectivityTest:NetworkManagementConnectivityTest", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
