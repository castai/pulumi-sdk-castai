...
func NewPubsubSchemaIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/pubsubSchemaIamMember:PubsubSchemaIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubSchemaIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/pubsubSchemaIamMember:PubsubSchemaIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
