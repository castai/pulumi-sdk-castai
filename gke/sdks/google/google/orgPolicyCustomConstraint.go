...
func NewOrgPolicyCustomConstraint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/orgPolicyCustomConstraint:OrgPolicyCustomConstraint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrgPolicyCustomConstraint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/orgPolicyCustomConstraint:OrgPolicyCustomConstraint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
