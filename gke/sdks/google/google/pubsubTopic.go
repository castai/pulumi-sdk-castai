...
func NewPubsubTopic(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/pubsubTopic:PubsubTopic", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubTopic(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/pubsubTopic:PubsubTopic", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
