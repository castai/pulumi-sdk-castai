...
func NewStorageNotification(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageNotification:StorageNotification", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageNotification(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageNotification:StorageNotification", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
