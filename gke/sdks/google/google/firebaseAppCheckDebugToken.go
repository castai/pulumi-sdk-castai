...
func NewFirebaseAppCheckDebugToken(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/firebaseAppCheckDebugToken:FirebaseAppCheckDebugToken", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckDebugToken(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/firebaseAppCheckDebugToken:FirebaseAppCheckDebugToken", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
