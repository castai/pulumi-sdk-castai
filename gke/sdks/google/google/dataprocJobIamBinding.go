...
func NewDataprocJobIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocJobIamBinding:DataprocJobIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocJobIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocJobIamBinding:DataprocJobIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
