...
func NewGkeBackupBackupPlanIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/gkeBackupBackupPlanIamPolicy:GkeBackupBackupPlanIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeBackupBackupPlanIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/gkeBackupBackupPlanIamPolicy:GkeBackupBackupPlanIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
