...
func NewSpannerDatabase(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerDatabase:SpannerDatabase", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerDatabase(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerDatabase:SpannerDatabase", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
