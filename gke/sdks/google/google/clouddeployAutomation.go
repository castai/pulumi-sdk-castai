...
func NewClouddeployAutomation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/clouddeployAutomation:ClouddeployAutomation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddeployAutomation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/clouddeployAutomation:ClouddeployAutomation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
