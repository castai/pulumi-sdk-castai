...
func NewIapTunnelIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapTunnelIamBinding:IapTunnelIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapTunnelIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapTunnelIamBinding:IapTunnelIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
