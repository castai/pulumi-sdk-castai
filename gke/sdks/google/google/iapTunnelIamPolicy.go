...
func NewIapTunnelIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapTunnelIamPolicy:IapTunnelIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapTunnelIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapTunnelIamPolicy:IapTunnelIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
