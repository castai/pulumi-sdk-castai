...
func NewDataprocClusterIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocClusterIamMember:DataprocClusterIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocClusterIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocClusterIamMember:DataprocClusterIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
