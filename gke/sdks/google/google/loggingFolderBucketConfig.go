...
func NewLoggingFolderBucketConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/loggingFolderBucketConfig:LoggingFolderBucketConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingFolderBucketConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/loggingFolderBucketConfig:LoggingFolderBucketConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
