...
func NewNetworkSecurityAuthzPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkSecurityAuthzPolicy:NetworkSecurityAuthzPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityAuthzPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkSecurityAuthzPolicy:NetworkSecurityAuthzPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
