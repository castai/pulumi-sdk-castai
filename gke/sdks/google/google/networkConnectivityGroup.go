...
func NewNetworkConnectivityGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkConnectivityGroup:NetworkConnectivityGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivityGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkConnectivityGroup:NetworkConnectivityGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
