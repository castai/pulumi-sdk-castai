...
func NewSecurityposturePosture(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/securityposturePosture:SecurityposturePosture", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityposturePosture(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/securityposturePosture:SecurityposturePosture", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
