...
func NewSpannerBackupSchedule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerBackupSchedule:SpannerBackupSchedule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerBackupSchedule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerBackupSchedule:SpannerBackupSchedule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
