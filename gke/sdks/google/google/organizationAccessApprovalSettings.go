...
func NewOrganizationAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/organizationAccessApprovalSettings:OrganizationAccessApprovalSettings", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/organizationAccessApprovalSettings:OrganizationAccessApprovalSettings", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
