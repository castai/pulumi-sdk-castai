...
func NewKmsEkmConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/kmsEkmConnection:KmsEkmConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsEkmConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/kmsEkmConnection:KmsEkmConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
