...
func NewTagsTagKeyIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/tagsTagKeyIamMember:TagsTagKeyIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagsTagKeyIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/tagsTagKeyIamMember:TagsTagKeyIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
