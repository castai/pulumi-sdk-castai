...
func NewFilestoreInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/filestoreInstance:FilestoreInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilestoreInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/filestoreInstance:FilestoreInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
