...
func NewComputeNodeGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNodeGroup:ComputeNodeGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNodeGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNodeGroup:ComputeNodeGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
