...
func NewDialogflowCxAgent(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxAgent:DialogflowCxAgent", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxAgent(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxAgent:DialogflowCxAgent", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
