...
func NewDataprocClusterIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocClusterIamPolicy:DataprocClusterIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocClusterIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocClusterIamPolicy:DataprocClusterIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
