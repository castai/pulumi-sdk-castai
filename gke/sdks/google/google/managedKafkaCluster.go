...
func NewManagedKafkaCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/managedKafkaCluster:ManagedKafkaCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetManagedKafkaCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/managedKafkaCluster:ManagedKafkaCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
