...
func NewIapAppEngineVersionIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapAppEngineVersionIamPolicy:IapAppEngineVersionIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapAppEngineVersionIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapAppEngineVersionIamPolicy:IapAppEngineVersionIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
