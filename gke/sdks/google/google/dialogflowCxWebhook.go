...
func NewDialogflowCxWebhook(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxWebhook:DialogflowCxWebhook", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxWebhook(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxWebhook:DialogflowCxWebhook", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
