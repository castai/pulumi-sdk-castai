...
func NewDiscoveryEngineDataStore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/discoveryEngineDataStore:DiscoveryEngineDataStore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryEngineDataStore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/discoveryEngineDataStore:DiscoveryEngineDataStore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
