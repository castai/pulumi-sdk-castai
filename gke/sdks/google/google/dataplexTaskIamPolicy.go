...
func NewDataplexTaskIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexTaskIamPolicy:DataplexTaskIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexTaskIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexTaskIamPolicy:DataplexTaskIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
