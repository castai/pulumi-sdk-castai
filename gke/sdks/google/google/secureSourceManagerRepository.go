...
func NewSecureSourceManagerRepository(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secureSourceManagerRepository:SecureSourceManagerRepository", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecureSourceManagerRepository(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secureSourceManagerRepository:SecureSourceManagerRepository", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
