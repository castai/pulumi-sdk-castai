...
func NewComputeNetworkPeering(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNetworkPeering:ComputeNetworkPeering", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNetworkPeering(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNetworkPeering:ComputeNetworkPeering", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
