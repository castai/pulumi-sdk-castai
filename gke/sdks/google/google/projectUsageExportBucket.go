...
func NewProjectUsageExportBucket(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectUsageExportBucket:ProjectUsageExportBucket", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectUsageExportBucket(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectUsageExportBucket:ProjectUsageExportBucket", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
