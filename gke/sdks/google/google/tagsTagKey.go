...
func NewTagsTagKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/tagsTagKey:TagsTagKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagsTagKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/tagsTagKey:TagsTagKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
