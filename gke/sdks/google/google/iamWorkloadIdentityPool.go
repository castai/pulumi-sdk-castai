...
func NewIamWorkloadIdentityPool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iamWorkloadIdentityPool:IamWorkloadIdentityPool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamWorkloadIdentityPool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iamWorkloadIdentityPool:IamWorkloadIdentityPool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
