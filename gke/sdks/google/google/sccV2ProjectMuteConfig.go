...
func NewSccV2ProjectMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccV2ProjectMuteConfig:SccV2ProjectMuteConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2ProjectMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccV2ProjectMuteConfig:SccV2ProjectMuteConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
