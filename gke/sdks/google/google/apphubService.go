...
func NewApphubService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/apphubService:ApphubService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApphubService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/apphubService:ApphubService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
