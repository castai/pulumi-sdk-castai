...
func NewNetappBackupVault(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/netappBackupVault:NetappBackupVault", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappBackupVault(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/netappBackupVault:NetappBackupVault", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
