...
func NewSecureSourceManagerRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secureSourceManagerRepositoryIamMember:SecureSourceManagerRepositoryIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecureSourceManagerRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secureSourceManagerRepositoryIamMember:SecureSourceManagerRepositoryIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
