...
func NewContainerAnalysisNoteIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/containerAnalysisNoteIamPolicy:ContainerAnalysisNoteIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAnalysisNoteIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/containerAnalysisNoteIamPolicy:ContainerAnalysisNoteIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
