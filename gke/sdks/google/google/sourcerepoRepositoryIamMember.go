...
func NewSourcerepoRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sourcerepoRepositoryIamMember:SourcerepoRepositoryIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSourcerepoRepositoryIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sourcerepoRepositoryIamMember:SourcerepoRepositoryIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
