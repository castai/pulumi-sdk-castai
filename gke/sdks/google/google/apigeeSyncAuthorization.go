...
func NewApigeeSyncAuthorization(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/apigeeSyncAuthorization:ApigeeSyncAuthorization", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeSyncAuthorization(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/apigeeSyncAuthorization:ApigeeSyncAuthorization", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
