...
func NewProjectService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectService:ProjectService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectService:ProjectService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
