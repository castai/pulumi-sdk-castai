...
func NewDatabaseMigrationServiceConnectionProfile(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/databaseMigrationServiceConnectionProfile:DatabaseMigrationServiceConnectionProfile", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseMigrationServiceConnectionProfile(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/databaseMigrationServiceConnectionProfile:DatabaseMigrationServiceConnectionProfile", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
