...
func NewSccV2FolderMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccV2FolderMuteConfig:SccV2FolderMuteConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2FolderMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccV2FolderMuteConfig:SccV2FolderMuteConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
