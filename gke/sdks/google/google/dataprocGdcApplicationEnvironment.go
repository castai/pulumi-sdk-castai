...
func NewDataprocGdcApplicationEnvironment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocGdcApplicationEnvironment:DataprocGdcApplicationEnvironment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocGdcApplicationEnvironment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocGdcApplicationEnvironment:DataprocGdcApplicationEnvironment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
