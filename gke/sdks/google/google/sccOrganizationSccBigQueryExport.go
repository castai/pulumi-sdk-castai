...
func NewSccOrganizationSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccOrganizationSccBigQueryExport:SccOrganizationSccBigQueryExport", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccOrganizationSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccOrganizationSccBigQueryExport:SccOrganizationSccBigQueryExport", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
