...
func NewStorageBucket(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageBucket:StorageBucket", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageBucket(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageBucket:StorageBucket", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
