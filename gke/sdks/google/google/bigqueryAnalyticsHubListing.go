...
func NewBigqueryAnalyticsHubListing(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryAnalyticsHubListing:BigqueryAnalyticsHubListing", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubListing(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryAnalyticsHubListing:BigqueryAnalyticsHubListing", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
