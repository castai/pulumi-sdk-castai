...
func NewSpannerDatabaseIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerDatabaseIamBinding:SpannerDatabaseIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerDatabaseIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerDatabaseIamBinding:SpannerDatabaseIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
