...
func NewBackupDrBackupVault(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/backupDrBackupVault:BackupDrBackupVault", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupDrBackupVault(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/backupDrBackupVault:BackupDrBackupVault", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
