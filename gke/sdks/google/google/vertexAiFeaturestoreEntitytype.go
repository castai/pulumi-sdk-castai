...
func NewVertexAiFeaturestoreEntitytype(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiFeaturestoreEntitytype:VertexAiFeaturestoreEntitytype", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeaturestoreEntitytype(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiFeaturestoreEntitytype:VertexAiFeaturestoreEntitytype", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
