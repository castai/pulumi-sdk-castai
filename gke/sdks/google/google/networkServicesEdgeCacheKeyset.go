...
func NewNetworkServicesEdgeCacheKeyset(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkServicesEdgeCacheKeyset:NetworkServicesEdgeCacheKeyset", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServicesEdgeCacheKeyset(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkServicesEdgeCacheKeyset:NetworkServicesEdgeCacheKeyset", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
