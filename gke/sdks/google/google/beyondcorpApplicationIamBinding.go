...
func NewBeyondcorpApplicationIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/beyondcorpApplicationIamBinding:BeyondcorpApplicationIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpApplicationIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/beyondcorpApplicationIamBinding:BeyondcorpApplicationIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
