...
func NewIapWebTypeComputeIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapWebTypeComputeIamMember:IapWebTypeComputeIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapWebTypeComputeIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapWebTypeComputeIamMember:IapWebTypeComputeIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
