...
func NewDocumentAiWarehouseLocation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/documentAiWarehouseLocation:DocumentAiWarehouseLocation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDocumentAiWarehouseLocation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/documentAiWarehouseLocation:DocumentAiWarehouseLocation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
