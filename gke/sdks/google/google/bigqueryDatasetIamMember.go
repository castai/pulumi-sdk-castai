...
func NewBigqueryDatasetIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDatasetIamMember:BigqueryDatasetIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatasetIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDatasetIamMember:BigqueryDatasetIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
