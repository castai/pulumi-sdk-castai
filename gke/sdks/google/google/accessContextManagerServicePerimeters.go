...
func NewAccessContextManagerServicePerimeters(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerServicePerimeters:AccessContextManagerServicePerimeters", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeters(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerServicePerimeters:AccessContextManagerServicePerimeters", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
