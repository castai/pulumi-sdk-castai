...
func NewDiscoveryEngineTargetSite(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/discoveryEngineTargetSite:DiscoveryEngineTargetSite", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryEngineTargetSite(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/discoveryEngineTargetSite:DiscoveryEngineTargetSite", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
