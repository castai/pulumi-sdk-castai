...
func NewCloudbuildTrigger(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudbuildTrigger:CloudbuildTrigger", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudbuildTrigger(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudbuildTrigger:CloudbuildTrigger", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
