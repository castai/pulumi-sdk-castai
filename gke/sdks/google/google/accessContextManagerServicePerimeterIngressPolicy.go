...
func NewAccessContextManagerServicePerimeterIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerServicePerimeterIngressPolicy:AccessContextManagerServicePerimeterIngressPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeterIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerServicePerimeterIngressPolicy:AccessContextManagerServicePerimeterIngressPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
