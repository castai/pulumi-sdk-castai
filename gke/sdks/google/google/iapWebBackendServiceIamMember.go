...
func NewIapWebBackendServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapWebBackendServiceIamMember:IapWebBackendServiceIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapWebBackendServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapWebBackendServiceIamMember:IapWebBackendServiceIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
