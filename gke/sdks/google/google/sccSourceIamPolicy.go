...
func NewSccSourceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccSourceIamPolicy:SccSourceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccSourceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccSourceIamPolicy:SccSourceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
