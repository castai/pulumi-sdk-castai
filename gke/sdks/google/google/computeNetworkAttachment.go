...
func NewComputeNetworkAttachment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNetworkAttachment:ComputeNetworkAttachment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNetworkAttachment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNetworkAttachment:ComputeNetworkAttachment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
