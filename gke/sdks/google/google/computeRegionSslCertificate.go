...
func NewComputeRegionSslCertificate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionSslCertificate:ComputeRegionSslCertificate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionSslCertificate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionSslCertificate:ComputeRegionSslCertificate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
