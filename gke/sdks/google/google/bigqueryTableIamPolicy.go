...
func NewBigqueryTableIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryTableIamPolicy:BigqueryTableIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryTableIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryTableIamPolicy:BigqueryTableIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
