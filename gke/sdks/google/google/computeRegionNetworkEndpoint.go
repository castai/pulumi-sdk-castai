...
func NewComputeRegionNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionNetworkEndpoint:ComputeRegionNetworkEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionNetworkEndpoint:ComputeRegionNetworkEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
