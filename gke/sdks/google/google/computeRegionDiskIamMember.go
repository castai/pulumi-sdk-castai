...
func NewComputeRegionDiskIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionDiskIamMember:ComputeRegionDiskIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionDiskIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionDiskIamMember:ComputeRegionDiskIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
