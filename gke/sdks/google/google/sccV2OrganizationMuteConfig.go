...
func NewSccV2OrganizationMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccV2OrganizationMuteConfig:SccV2OrganizationMuteConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2OrganizationMuteConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccV2OrganizationMuteConfig:SccV2OrganizationMuteConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
