...
func NewComputePublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computePublicAdvertisedPrefix:ComputePublicAdvertisedPrefix", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputePublicAdvertisedPrefix(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computePublicAdvertisedPrefix:ComputePublicAdvertisedPrefix", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
