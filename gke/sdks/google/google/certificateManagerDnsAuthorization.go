...
func NewCertificateManagerDnsAuthorization(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/certificateManagerDnsAuthorization:CertificateManagerDnsAuthorization", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateManagerDnsAuthorization(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/certificateManagerDnsAuthorization:CertificateManagerDnsAuthorization", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
