...
func NewContainerAnalysisOccurrence(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/containerAnalysisOccurrence:ContainerAnalysisOccurrence", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAnalysisOccurrence(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/containerAnalysisOccurrence:ContainerAnalysisOccurrence", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
