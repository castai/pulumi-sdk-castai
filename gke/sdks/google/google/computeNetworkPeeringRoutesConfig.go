...
func NewComputeNetworkPeeringRoutesConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNetworkPeeringRoutesConfig:ComputeNetworkPeeringRoutesConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNetworkPeeringRoutesConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNetworkPeeringRoutesConfig:ComputeNetworkPeeringRoutesConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
