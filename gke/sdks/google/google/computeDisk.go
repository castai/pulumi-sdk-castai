...
func NewComputeDisk(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeDisk:ComputeDisk", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeDisk(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeDisk:ComputeDisk", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
