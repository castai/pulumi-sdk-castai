...
func NewGkeBackupBackupPlanIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/gkeBackupBackupPlanIamBinding:GkeBackupBackupPlanIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeBackupBackupPlanIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/gkeBackupBackupPlanIamBinding:GkeBackupBackupPlanIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
