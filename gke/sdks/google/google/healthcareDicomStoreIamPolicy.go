...
func NewHealthcareDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/healthcareDicomStoreIamPolicy:HealthcareDicomStoreIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareDicomStoreIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/healthcareDicomStoreIamPolicy:HealthcareDicomStoreIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
