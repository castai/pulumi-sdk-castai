...
func NewCloudbuildv2ConnectionIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudbuildv2ConnectionIamMember:Cloudbuildv2ConnectionIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudbuildv2ConnectionIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudbuildv2ConnectionIamMember:Cloudbuildv2ConnectionIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
