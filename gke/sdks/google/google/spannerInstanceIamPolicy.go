...
func NewSpannerInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerInstanceIamPolicy:SpannerInstanceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerInstanceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerInstanceIamPolicy:SpannerInstanceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
