...
func NewAccessContextManagerServicePerimeterDryRunEgressPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerServicePerimeterDryRunEgressPolicy:AccessContextManagerServicePerimeterDryRunEgressPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeterDryRunEgressPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerServicePerimeterDryRunEgressPolicy:AccessContextManagerServicePerimeterDryRunEgressPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
