...
func NewTranscoderJobTemplate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/transcoderJobTemplate:TranscoderJobTemplate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTranscoderJobTemplate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/transcoderJobTemplate:TranscoderJobTemplate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
