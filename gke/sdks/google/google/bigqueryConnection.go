...
func NewBigqueryConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryConnection:BigqueryConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryConnection:BigqueryConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
