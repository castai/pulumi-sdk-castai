...
func NewDataCatalogEntryGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataCatalogEntryGroup:DataCatalogEntryGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogEntryGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataCatalogEntryGroup:DataCatalogEntryGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
