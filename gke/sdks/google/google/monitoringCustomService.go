...
func NewMonitoringCustomService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/monitoringCustomService:MonitoringCustomService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringCustomService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/monitoringCustomService:MonitoringCustomService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
