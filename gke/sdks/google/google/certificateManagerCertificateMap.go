...
func NewCertificateManagerCertificateMap(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/certificateManagerCertificateMap:CertificateManagerCertificateMap", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateManagerCertificateMap(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/certificateManagerCertificateMap:CertificateManagerCertificateMap", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
