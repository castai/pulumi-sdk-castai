...
func NewComputeRegionHealthCheck(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeRegionHealthCheck:ComputeRegionHealthCheck", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionHealthCheck(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeRegionHealthCheck:ComputeRegionHealthCheck", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
