...
func NewHealthcareDicomStoreIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/healthcareDicomStoreIamBinding:HealthcareDicomStoreIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareDicomStoreIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/healthcareDicomStoreIamBinding:HealthcareDicomStoreIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
