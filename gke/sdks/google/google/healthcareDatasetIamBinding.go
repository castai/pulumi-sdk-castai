...
func NewHealthcareDatasetIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/healthcareDatasetIamBinding:HealthcareDatasetIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareDatasetIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/healthcareDatasetIamBinding:HealthcareDatasetIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
