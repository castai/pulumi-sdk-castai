...
func NewSpannerDatabaseIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/spannerDatabaseIamPolicy:SpannerDatabaseIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerDatabaseIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/spannerDatabaseIamPolicy:SpannerDatabaseIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
