...
func NewVertexAiDeploymentResourcePool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiDeploymentResourcePool:VertexAiDeploymentResourcePool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiDeploymentResourcePool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiDeploymentResourcePool:VertexAiDeploymentResourcePool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
