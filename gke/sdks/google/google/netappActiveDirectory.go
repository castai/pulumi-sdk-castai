...
func NewNetappActiveDirectory(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/netappActiveDirectory:NetappActiveDirectory", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappActiveDirectory(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/netappActiveDirectory:NetappActiveDirectory", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
