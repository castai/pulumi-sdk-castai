...
func NewBigqueryAnalyticsHubDataExchangeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryAnalyticsHubDataExchangeIamPolicy:BigqueryAnalyticsHubDataExchangeIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubDataExchangeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryAnalyticsHubDataExchangeIamPolicy:BigqueryAnalyticsHubDataExchangeIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
