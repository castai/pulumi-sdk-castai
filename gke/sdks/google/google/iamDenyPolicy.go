...
func NewIamDenyPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iamDenyPolicy:IamDenyPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamDenyPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iamDenyPolicy:IamDenyPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
