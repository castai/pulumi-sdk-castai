...
func NewApikeysKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/apikeysKey:ApikeysKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApikeysKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/apikeysKey:ApikeysKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
