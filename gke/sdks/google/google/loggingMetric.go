...
func NewLoggingMetric(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/loggingMetric:LoggingMetric", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingMetric(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/loggingMetric:LoggingMetric", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
