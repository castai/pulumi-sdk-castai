...
func NewEndpointsServiceConsumersIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/endpointsServiceConsumersIamPolicy:EndpointsServiceConsumersIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointsServiceConsumersIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/endpointsServiceConsumersIamPolicy:EndpointsServiceConsumersIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
