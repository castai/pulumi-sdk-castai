...
func NewPubsubLiteTopic(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/pubsubLiteTopic:PubsubLiteTopic", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubLiteTopic(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/pubsubLiteTopic:PubsubLiteTopic", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
