...
func NewComputeTargetPool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeTargetPool:ComputeTargetPool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeTargetPool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeTargetPool:ComputeTargetPool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
