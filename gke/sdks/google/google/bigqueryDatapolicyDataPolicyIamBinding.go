...
func NewBigqueryDatapolicyDataPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDatapolicyDataPolicyIamBinding:BigqueryDatapolicyDataPolicyIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatapolicyDataPolicyIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDatapolicyDataPolicyIamBinding:BigqueryDatapolicyDataPolicyIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
