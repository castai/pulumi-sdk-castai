...
func NewNetappVolumeSnapshot(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/netappVolumeSnapshot:NetappVolumeSnapshot", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappVolumeSnapshot(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/netappVolumeSnapshot:NetappVolumeSnapshot", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
