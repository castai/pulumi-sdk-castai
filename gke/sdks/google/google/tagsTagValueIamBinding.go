...
func NewTagsTagValueIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/tagsTagValueIamBinding:TagsTagValueIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTagsTagValueIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/tagsTagValueIamBinding:TagsTagValueIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
