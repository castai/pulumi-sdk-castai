...
func NewNetworkServicesGateway(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkServicesGateway:NetworkServicesGateway", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServicesGateway(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkServicesGateway:NetworkServicesGateway", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
