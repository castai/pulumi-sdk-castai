...
func NewBigqueryDatasetAccess(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDatasetAccess:BigqueryDatasetAccess", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatasetAccess(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDatasetAccess:BigqueryDatasetAccess", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
