...
func NewDataPipelinePipeline(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataPipelinePipeline:DataPipelinePipeline", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataPipelinePipeline(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataPipelinePipeline:DataPipelinePipeline", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
