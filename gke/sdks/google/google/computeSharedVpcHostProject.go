...
func NewComputeSharedVpcHostProject(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSharedVpcHostProject:ComputeSharedVpcHostProject", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSharedVpcHostProject(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSharedVpcHostProject:ComputeSharedVpcHostProject", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
