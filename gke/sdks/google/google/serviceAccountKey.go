...
func NewServiceAccountKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/serviceAccountKey:ServiceAccountKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccountKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/serviceAccountKey:ServiceAccountKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
