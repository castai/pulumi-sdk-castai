...
func NewProjectAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectAccessApprovalSettings:ProjectAccessApprovalSettings", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectAccessApprovalSettings(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectAccessApprovalSettings:ProjectAccessApprovalSettings", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
