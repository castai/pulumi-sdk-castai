...
func NewProjectIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectIamPolicy:ProjectIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectIamPolicy:ProjectIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
