...
func NewIapWebTypeComputeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapWebTypeComputeIamPolicy:IapWebTypeComputeIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapWebTypeComputeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapWebTypeComputeIamPolicy:IapWebTypeComputeIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
