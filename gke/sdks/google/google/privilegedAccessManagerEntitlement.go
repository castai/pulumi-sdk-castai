...
func NewPrivilegedAccessManagerEntitlement(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/privilegedAccessManagerEntitlement:PrivilegedAccessManagerEntitlement", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivilegedAccessManagerEntitlement(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/privilegedAccessManagerEntitlement:PrivilegedAccessManagerEntitlement", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
