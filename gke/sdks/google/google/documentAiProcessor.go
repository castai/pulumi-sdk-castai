...
func NewDocumentAiProcessor(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/documentAiProcessor:DocumentAiProcessor", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDocumentAiProcessor(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/documentAiProcessor:DocumentAiProcessor", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
