...
func NewMigrationCenterGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/migrationCenterGroup:MigrationCenterGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMigrationCenterGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/migrationCenterGroup:MigrationCenterGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
