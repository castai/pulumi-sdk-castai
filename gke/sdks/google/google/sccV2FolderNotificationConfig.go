...
func NewSccV2FolderNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccV2FolderNotificationConfig:SccV2FolderNotificationConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2FolderNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccV2FolderNotificationConfig:SccV2FolderNotificationConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
