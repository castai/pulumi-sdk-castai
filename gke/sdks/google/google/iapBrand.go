...
func NewIapBrand(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapBrand:IapBrand", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapBrand(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapBrand:IapBrand", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
