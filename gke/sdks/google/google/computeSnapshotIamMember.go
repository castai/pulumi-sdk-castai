...
func NewComputeSnapshotIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeSnapshotIamMember:ComputeSnapshotIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSnapshotIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeSnapshotIamMember:ComputeSnapshotIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
