...
func NewPubsubTopicIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/pubsubTopicIamMember:PubsubTopicIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubTopicIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/pubsubTopicIamMember:PubsubTopicIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
