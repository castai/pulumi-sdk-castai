...
func NewDialogflowCxEntityType(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowCxEntityType:DialogflowCxEntityType", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxEntityType(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowCxEntityType:DialogflowCxEntityType", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
