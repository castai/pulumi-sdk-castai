...
func NewBeyondcorpApplicationIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/beyondcorpApplicationIamMember:BeyondcorpApplicationIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpApplicationIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/beyondcorpApplicationIamMember:BeyondcorpApplicationIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
