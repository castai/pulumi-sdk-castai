...
func NewComputeDiskIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeDiskIamPolicy:ComputeDiskIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeDiskIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeDiskIamPolicy:ComputeDiskIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
