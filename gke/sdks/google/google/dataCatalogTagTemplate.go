...
func NewDataCatalogTagTemplate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataCatalogTagTemplate:DataCatalogTagTemplate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogTagTemplate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataCatalogTagTemplate:DataCatalogTagTemplate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
