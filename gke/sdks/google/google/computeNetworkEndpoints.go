...
func NewComputeNetworkEndpoints(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNetworkEndpoints:ComputeNetworkEndpoints", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNetworkEndpoints(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNetworkEndpoints:ComputeNetworkEndpoints", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
