...
func NewSccV2OrganizationNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccV2OrganizationNotificationConfig:SccV2OrganizationNotificationConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2OrganizationNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccV2OrganizationNotificationConfig:SccV2OrganizationNotificationConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
