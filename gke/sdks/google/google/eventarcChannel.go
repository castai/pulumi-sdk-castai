...
func NewEventarcChannel(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/eventarcChannel:EventarcChannel", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventarcChannel(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/eventarcChannel:EventarcChannel", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
