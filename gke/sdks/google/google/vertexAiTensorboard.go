...
func NewVertexAiTensorboard(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiTensorboard:VertexAiTensorboard", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiTensorboard(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiTensorboard:VertexAiTensorboard", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
