...
func NewProjectIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectIamBinding:ProjectIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectIamBinding:ProjectIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
