...
func NewFirebaserulesRelease(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/firebaserulesRelease:FirebaserulesRelease", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaserulesRelease(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/firebaserulesRelease:FirebaserulesRelease", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
