...
func NewContainerRegistry(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/containerRegistry:ContainerRegistry", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerRegistry(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/containerRegistry:ContainerRegistry", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
