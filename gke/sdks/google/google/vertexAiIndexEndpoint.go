...
func NewVertexAiIndexEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiIndexEndpoint:VertexAiIndexEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiIndexEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiIndexEndpoint:VertexAiIndexEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
