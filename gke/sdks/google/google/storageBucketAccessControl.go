...
func NewStorageBucketAccessControl(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageBucketAccessControl:StorageBucketAccessControl", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageBucketAccessControl(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageBucketAccessControl:StorageBucketAccessControl", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
