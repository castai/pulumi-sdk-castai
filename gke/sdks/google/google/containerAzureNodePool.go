...
func NewContainerAzureNodePool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/containerAzureNodePool:ContainerAzureNodePool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAzureNodePool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/containerAzureNodePool:ContainerAzureNodePool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
