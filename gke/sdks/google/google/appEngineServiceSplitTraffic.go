...
func NewAppEngineServiceSplitTraffic(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/appEngineServiceSplitTraffic:AppEngineServiceSplitTraffic", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppEngineServiceSplitTraffic(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/appEngineServiceSplitTraffic:AppEngineServiceSplitTraffic", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
