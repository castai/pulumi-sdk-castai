...
func NewDnsPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dnsPolicy:DnsPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dnsPolicy:DnsPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
