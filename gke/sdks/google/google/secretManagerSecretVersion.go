...
func NewSecretManagerSecretVersion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secretManagerSecretVersion:SecretManagerSecretVersion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretManagerSecretVersion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secretManagerSecretVersion:SecretManagerSecretVersion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
