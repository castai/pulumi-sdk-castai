...
func NewVmwareengineNetworkPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vmwareengineNetworkPolicy:VmwareengineNetworkPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareengineNetworkPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vmwareengineNetworkPolicy:VmwareengineNetworkPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
