...
func NewSecureSourceManagerInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/secureSourceManagerInstance:SecureSourceManagerInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecureSourceManagerInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/secureSourceManagerInstance:SecureSourceManagerInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
