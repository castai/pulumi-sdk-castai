...
func NewBigtableInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigtableInstanceIamBinding:BigtableInstanceIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigtableInstanceIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigtableInstanceIamBinding:BigtableInstanceIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
