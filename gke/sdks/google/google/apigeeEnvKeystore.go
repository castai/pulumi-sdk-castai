...
func NewApigeeEnvKeystore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/apigeeEnvKeystore:ApigeeEnvKeystore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeEnvKeystore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/apigeeEnvKeystore:ApigeeEnvKeystore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
