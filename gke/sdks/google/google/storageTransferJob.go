...
func NewStorageTransferJob(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/storageTransferJob:StorageTransferJob", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageTransferJob(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/storageTransferJob:StorageTransferJob", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
