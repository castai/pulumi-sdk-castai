...
func NewFirebaseAppCheckRecaptchaV3Config(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/firebaseAppCheckRecaptchaV3Config:FirebaseAppCheckRecaptchaV3Config", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckRecaptchaV3Config(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/firebaseAppCheckRecaptchaV3Config:FirebaseAppCheckRecaptchaV3Config", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
