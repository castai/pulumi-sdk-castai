...
func NewCertificateManagerCertificateMapEntry(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/certificateManagerCertificateMapEntry:CertificateManagerCertificateMapEntry", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateManagerCertificateMapEntry(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/certificateManagerCertificateMapEntry:CertificateManagerCertificateMapEntry", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
