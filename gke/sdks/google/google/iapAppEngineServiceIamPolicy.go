...
func NewIapAppEngineServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapAppEngineServiceIamPolicy:IapAppEngineServiceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapAppEngineServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapAppEngineServiceIamPolicy:IapAppEngineServiceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
