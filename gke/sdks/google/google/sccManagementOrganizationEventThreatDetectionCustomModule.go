...
func NewSccManagementOrganizationEventThreatDetectionCustomModule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/sccManagementOrganizationEventThreatDetectionCustomModule:SccManagementOrganizationEventThreatDetectionCustomModule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccManagementOrganizationEventThreatDetectionCustomModule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/sccManagementOrganizationEventThreatDetectionCustomModule:SccManagementOrganizationEventThreatDetectionCustomModule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
