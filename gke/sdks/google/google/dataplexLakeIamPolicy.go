...
func NewDataplexLakeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexLakeIamPolicy:DataplexLakeIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexLakeIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexLakeIamPolicy:DataplexLakeIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
