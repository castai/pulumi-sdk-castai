...
func NewBigqueryReservation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryReservation:BigqueryReservation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryReservation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryReservation:BigqueryReservation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
