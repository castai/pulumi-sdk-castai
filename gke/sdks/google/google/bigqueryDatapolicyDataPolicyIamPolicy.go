...
func NewBigqueryDatapolicyDataPolicyIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryDatapolicyDataPolicyIamPolicy:BigqueryDatapolicyDataPolicyIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatapolicyDataPolicyIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryDatapolicyDataPolicyIamPolicy:BigqueryDatapolicyDataPolicyIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
