...
func NewLoggingLogView(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/loggingLogView:LoggingLogView", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingLogView(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/loggingLogView:LoggingLogView", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
