...
func NewKmsSecretCiphertext(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/kmsSecretCiphertext:KmsSecretCiphertext", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsSecretCiphertext(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/kmsSecretCiphertext:KmsSecretCiphertext", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
