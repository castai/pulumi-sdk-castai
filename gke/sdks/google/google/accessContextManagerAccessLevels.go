...
func NewAccessContextManagerAccessLevels(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerAccessLevels:AccessContextManagerAccessLevels", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessLevels(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerAccessLevels:AccessContextManagerAccessLevels", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
