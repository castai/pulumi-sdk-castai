...
func NewBigqueryAnalyticsHubDataExchange(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/bigqueryAnalyticsHubDataExchange:BigqueryAnalyticsHubDataExchange", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubDataExchange(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/bigqueryAnalyticsHubDataExchange:BigqueryAnalyticsHubDataExchange", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
