...
func NewNetworkConnectivityHub(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/networkConnectivityHub:NetworkConnectivityHub", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivityHub(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/networkConnectivityHub:NetworkConnectivityHub", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
