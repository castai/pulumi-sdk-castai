...
func NewVertexAiFeaturestore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/vertexAiFeaturestore:VertexAiFeaturestore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeaturestore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/vertexAiFeaturestore:VertexAiFeaturestore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
