...
func NewComputeNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeNetworkEndpoint:ComputeNetworkEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeNetworkEndpoint:ComputeNetworkEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
