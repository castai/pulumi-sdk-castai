...
func NewProjectOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/projectOrganizationPolicy:ProjectOrganizationPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/projectOrganizationPolicy:ProjectOrganizationPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
