...
func NewCloudbuildBitbucketServerConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudbuildBitbucketServerConfig:CloudbuildBitbucketServerConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudbuildBitbucketServerConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudbuildBitbucketServerConfig:CloudbuildBitbucketServerConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
