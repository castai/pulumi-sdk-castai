...
func NewAlloydbUser(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/alloydbUser:AlloydbUser", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlloydbUser(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/alloydbUser:AlloydbUser", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
