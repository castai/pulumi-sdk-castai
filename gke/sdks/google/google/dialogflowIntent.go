...
func NewDialogflowIntent(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dialogflowIntent:DialogflowIntent", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowIntent(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dialogflowIntent:DialogflowIntent", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
