...
func NewDataprocClusterIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataprocClusterIamBinding:DataprocClusterIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocClusterIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataprocClusterIamBinding:DataprocClusterIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
