...
func NewPrivatecaCertificateTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/privatecaCertificateTemplateIamPolicy:PrivatecaCertificateTemplateIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivatecaCertificateTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/privatecaCertificateTemplateIamPolicy:PrivatecaCertificateTemplateIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
