...
func NewDataplexAssetIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexAssetIamMember:DataplexAssetIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAssetIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexAssetIamMember:DataplexAssetIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
