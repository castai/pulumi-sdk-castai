...
func NewAccessContextManagerServicePerimeterDryRunIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/accessContextManagerServicePerimeterDryRunIngressPolicy:AccessContextManagerServicePerimeterDryRunIngressPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeterDryRunIngressPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/accessContextManagerServicePerimeterDryRunIngressPolicy:AccessContextManagerServicePerimeterDryRunIngressPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
