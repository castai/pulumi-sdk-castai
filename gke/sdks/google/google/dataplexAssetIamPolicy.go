...
func NewDataplexAssetIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/dataplexAssetIamPolicy:DataplexAssetIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAssetIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/dataplexAssetIamPolicy:DataplexAssetIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
