...
func NewPubsubTopicIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/pubsubTopicIamPolicy:PubsubTopicIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubTopicIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/pubsubTopicIamPolicy:PubsubTopicIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
