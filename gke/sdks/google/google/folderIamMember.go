...
func NewFolderIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/folderIamMember:FolderIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/folderIamMember:FolderIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
