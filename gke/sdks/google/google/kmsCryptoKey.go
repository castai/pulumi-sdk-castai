...
func NewKmsCryptoKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/kmsCryptoKey:KmsCryptoKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsCryptoKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/kmsCryptoKey:KmsCryptoKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
