...
func NewIapWebTypeComputeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/iapWebTypeComputeIamBinding:IapWebTypeComputeIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapWebTypeComputeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/iapWebTypeComputeIamBinding:IapWebTypeComputeIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
