...
func NewEndpointsServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/endpointsServiceIamPolicy:EndpointsServiceIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointsServiceIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/endpointsServiceIamPolicy:EndpointsServiceIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
