...
func NewComputeGlobalNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/computeGlobalNetworkEndpoint:ComputeGlobalNetworkEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeGlobalNetworkEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/computeGlobalNetworkEndpoint:ComputeGlobalNetworkEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
