...
func NewCloudTasksQueueIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/cloudTasksQueueIamPolicy:CloudTasksQueueIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudTasksQueueIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/cloudTasksQueueIamPolicy:CloudTasksQueueIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
