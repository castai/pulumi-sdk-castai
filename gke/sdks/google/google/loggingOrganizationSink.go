...
func NewLoggingOrganizationSink(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google:index/loggingOrganizationSink:LoggingOrganizationSink", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingOrganizationSink(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google:index/loggingOrganizationSink:LoggingOrganizationSink", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
