...
func NewArtifactRegistryRepositoryIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/artifactRegistryRepositoryIamBinding:ArtifactRegistryRepositoryIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactRegistryRepositoryIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/artifactRegistryRepositoryIamBinding:ArtifactRegistryRepositoryIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
