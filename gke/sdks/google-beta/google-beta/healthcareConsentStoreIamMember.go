...
func NewHealthcareConsentStoreIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/healthcareConsentStoreIamMember:HealthcareConsentStoreIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareConsentStoreIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/healthcareConsentStoreIamMember:HealthcareConsentStoreIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
