...
func NewDataCatalogTagTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataCatalogTagTemplateIamPolicy:DataCatalogTagTemplateIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogTagTemplateIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataCatalogTagTemplateIamPolicy:DataCatalogTagTemplateIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
