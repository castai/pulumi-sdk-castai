...
func NewGkeBackupRestorePlanIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/gkeBackupRestorePlanIamBinding:GkeBackupRestorePlanIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeBackupRestorePlanIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/gkeBackupRestorePlanIamBinding:GkeBackupRestorePlanIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
