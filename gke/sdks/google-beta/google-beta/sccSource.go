...
func NewSccSource(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccSource:SccSource", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccSource(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccSource:SccSource", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
