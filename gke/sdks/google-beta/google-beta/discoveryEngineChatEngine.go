...
func NewDiscoveryEngineChatEngine(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/discoveryEngineChatEngine:DiscoveryEngineChatEngine", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryEngineChatEngine(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/discoveryEngineChatEngine:DiscoveryEngineChatEngine", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
