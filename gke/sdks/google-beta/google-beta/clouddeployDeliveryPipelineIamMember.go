...
func NewClouddeployDeliveryPipelineIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/clouddeployDeliveryPipelineIamMember:ClouddeployDeliveryPipelineIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddeployDeliveryPipelineIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/clouddeployDeliveryPipelineIamMember:ClouddeployDeliveryPipelineIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
