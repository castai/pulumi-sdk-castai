...
func NewBinaryAuthorizationAttestorIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/binaryAuthorizationAttestorIamPolicy:BinaryAuthorizationAttestorIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinaryAuthorizationAttestorIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/binaryAuthorizationAttestorIamPolicy:BinaryAuthorizationAttestorIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
