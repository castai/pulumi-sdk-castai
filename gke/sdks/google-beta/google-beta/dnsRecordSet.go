...
func NewDnsRecordSet(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dnsRecordSet:DnsRecordSet", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsRecordSet(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dnsRecordSet:DnsRecordSet", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
