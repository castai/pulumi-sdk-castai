...
func NewGeminiRepositoryGroupIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/geminiRepositoryGroupIamPolicy:GeminiRepositoryGroupIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGeminiRepositoryGroupIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/geminiRepositoryGroupIamPolicy:GeminiRepositoryGroupIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
