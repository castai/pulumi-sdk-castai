...
func NewCloudbuildv2Repository(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudbuildv2Repository:Cloudbuildv2Repository", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudbuildv2Repository(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudbuildv2Repository:Cloudbuildv2Repository", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
