...
func NewFirestoreDocument(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firestoreDocument:FirestoreDocument", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirestoreDocument(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firestoreDocument:FirestoreDocument", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
