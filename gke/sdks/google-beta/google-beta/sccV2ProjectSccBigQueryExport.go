...
func NewSccV2ProjectSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccV2ProjectSccBigQueryExport:SccV2ProjectSccBigQueryExport", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2ProjectSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccV2ProjectSccBigQueryExport:SccV2ProjectSccBigQueryExport", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
