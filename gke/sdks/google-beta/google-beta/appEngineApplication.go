...
func NewAppEngineApplication(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/appEngineApplication:AppEngineApplication", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppEngineApplication(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/appEngineApplication:AppEngineApplication", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
