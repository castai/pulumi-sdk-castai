...
func NewNetworkConnectivityInternalRange(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkConnectivityInternalRange:NetworkConnectivityInternalRange", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivityInternalRange(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkConnectivityInternalRange:NetworkConnectivityInternalRange", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
