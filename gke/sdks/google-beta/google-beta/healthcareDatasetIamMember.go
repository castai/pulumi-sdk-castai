...
func NewHealthcareDatasetIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/healthcareDatasetIamMember:HealthcareDatasetIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareDatasetIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/healthcareDatasetIamMember:HealthcareDatasetIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
