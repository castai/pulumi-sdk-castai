...
func LookupKmsCryptoKey(ctx *pulumi.Context, args *LookupKmsCryptoKeyArgs, opts ...pulumi.InvokeOption) (*LookupKmsCryptoKeyResult, error) {
	...
	err = ctx.InvokePackage("google-beta:index/getKmsCryptoKey:getKmsCryptoKey", args, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKmsCryptoKeyOutput(ctx *pulumi.Context, args LookupKmsCryptoKeyOutputArgs, opts ...pulumi.InvokeOption) LookupKmsCryptoKeyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKmsCryptoKeyResultOutput, error) {
			...
			return ctx.InvokeOutput("google-beta:index/getKmsCryptoKey:getKmsCryptoKey", args, LookupKmsCryptoKeyResultOutput{}, options).(LookupKmsCryptoKeyResultOutput), nil
...
func (o LookupKmsCryptoKeyResultOutput) KeyAccessJustificationsPolicies() GetKmsCryptoKeyKeyAccessJustificationsPolicyArrayOutput {
	return o.ApplyT(func(v LookupKmsCryptoKeyResult) []GetKmsCryptoKeyKeyAccessJustificationsPolicy {
