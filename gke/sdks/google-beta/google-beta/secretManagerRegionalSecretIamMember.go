...
func NewSecretManagerRegionalSecretIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/secretManagerRegionalSecretIamMember:SecretManagerRegionalSecretIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretManagerRegionalSecretIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/secretManagerRegionalSecretIamMember:SecretManagerRegionalSecretIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
