...
func NewDataprocJob(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocJob:DataprocJob", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocJob(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocJob:DataprocJob", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
