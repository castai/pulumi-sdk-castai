...
func NewComputeReservation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeReservation:ComputeReservation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeReservation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeReservation:ComputeReservation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
