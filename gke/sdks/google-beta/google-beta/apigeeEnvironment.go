...
func NewApigeeEnvironment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeEnvironment:ApigeeEnvironment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeEnvironment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeEnvironment:ApigeeEnvironment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
