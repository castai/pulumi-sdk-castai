...
func NewSpannerDatabaseIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/spannerDatabaseIamMember:SpannerDatabaseIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpannerDatabaseIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/spannerDatabaseIamMember:SpannerDatabaseIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
