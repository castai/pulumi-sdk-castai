...
func NewDataplexAspectType(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataplexAspectType:DataplexAspectType", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexAspectType(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataplexAspectType:DataplexAspectType", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
