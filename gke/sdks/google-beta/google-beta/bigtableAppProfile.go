...
func NewBigtableAppProfile(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigtableAppProfile:BigtableAppProfile", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigtableAppProfile(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigtableAppProfile:BigtableAppProfile", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
