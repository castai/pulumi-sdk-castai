...
func NewComputeResourcePolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeResourcePolicy:ComputeResourcePolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeResourcePolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeResourcePolicy:ComputeResourcePolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
