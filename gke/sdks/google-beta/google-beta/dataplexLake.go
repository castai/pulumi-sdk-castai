...
func NewDataplexLake(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataplexLake:DataplexLake", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexLake(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataplexLake:DataplexLake", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
