...
func NewDataprocMetastoreFederation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocMetastoreFederation:DataprocMetastoreFederation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocMetastoreFederation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocMetastoreFederation:DataprocMetastoreFederation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
