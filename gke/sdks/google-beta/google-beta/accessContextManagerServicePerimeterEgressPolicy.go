...
func NewAccessContextManagerServicePerimeterEgressPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerServicePerimeterEgressPolicy:AccessContextManagerServicePerimeterEgressPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeterEgressPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerServicePerimeterEgressPolicy:AccessContextManagerServicePerimeterEgressPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
