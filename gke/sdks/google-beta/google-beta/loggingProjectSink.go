...
func NewLoggingProjectSink(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingProjectSink:LoggingProjectSink", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingProjectSink(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingProjectSink:LoggingProjectSink", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
