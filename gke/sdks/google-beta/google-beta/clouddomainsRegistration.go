...
func NewClouddomainsRegistration(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/clouddomainsRegistration:ClouddomainsRegistration", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddomainsRegistration(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/clouddomainsRegistration:ClouddomainsRegistration", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
