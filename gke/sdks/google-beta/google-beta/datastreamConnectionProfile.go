...
func NewDatastreamConnectionProfile(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/datastreamConnectionProfile:DatastreamConnectionProfile", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastreamConnectionProfile(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/datastreamConnectionProfile:DatastreamConnectionProfile", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
