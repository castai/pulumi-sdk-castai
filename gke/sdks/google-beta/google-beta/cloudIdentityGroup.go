...
func NewCloudIdentityGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudIdentityGroup:CloudIdentityGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudIdentityGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudIdentityGroup:CloudIdentityGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
