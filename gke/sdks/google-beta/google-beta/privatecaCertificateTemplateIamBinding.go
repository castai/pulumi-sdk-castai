...
func NewPrivatecaCertificateTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/privatecaCertificateTemplateIamBinding:PrivatecaCertificateTemplateIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivatecaCertificateTemplateIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/privatecaCertificateTemplateIamBinding:PrivatecaCertificateTemplateIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
