...
func NewGkeBackupBackupPlanIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/gkeBackupBackupPlanIamMember:GkeBackupBackupPlanIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeBackupBackupPlanIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/gkeBackupBackupPlanIamMember:GkeBackupBackupPlanIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
