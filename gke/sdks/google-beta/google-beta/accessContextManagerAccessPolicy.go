...
func NewAccessContextManagerAccessPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerAccessPolicy:AccessContextManagerAccessPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerAccessPolicy:AccessContextManagerAccessPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
