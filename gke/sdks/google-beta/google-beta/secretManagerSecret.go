...
func NewSecretManagerSecret(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/secretManagerSecret:SecretManagerSecret", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretManagerSecret(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/secretManagerSecret:SecretManagerSecret", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
