...
func NewDataFusionInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataFusionInstance:DataFusionInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataFusionInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataFusionInstance:DataFusionInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
//
// Deprecated: Deprecated
func (o DataFusionInstanceOutput) ServiceAccount() pulumi.StringOutput {
	return o.ApplyT(func(v *DataFusionInstance) pulumi.StringOutput { return v.ServiceAccount }).(pulumi.StringOutput)
}
