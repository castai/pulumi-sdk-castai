...
func NewVertexAiIndex(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vertexAiIndex:VertexAiIndex", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiIndex(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vertexAiIndex:VertexAiIndex", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
