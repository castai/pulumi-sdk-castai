...
func NewNetappBackupPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/netappBackupPolicy:NetappBackupPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappBackupPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/netappBackupPolicy:NetappBackupPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
