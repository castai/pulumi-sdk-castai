...
func NewIdentityPlatformTenantDefaultSupportedIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/identityPlatformTenantDefaultSupportedIdpConfig:IdentityPlatformTenantDefaultSupportedIdpConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformTenantDefaultSupportedIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/identityPlatformTenantDefaultSupportedIdpConfig:IdentityPlatformTenantDefaultSupportedIdpConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
