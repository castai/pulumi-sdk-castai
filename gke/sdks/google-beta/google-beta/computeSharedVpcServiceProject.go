...
func NewComputeSharedVpcServiceProject(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeSharedVpcServiceProject:ComputeSharedVpcServiceProject", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSharedVpcServiceProject(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeSharedVpcServiceProject:ComputeSharedVpcServiceProject", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
