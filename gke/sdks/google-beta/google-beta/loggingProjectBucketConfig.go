...
func NewLoggingProjectBucketConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingProjectBucketConfig:LoggingProjectBucketConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingProjectBucketConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingProjectBucketConfig:LoggingProjectBucketConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
