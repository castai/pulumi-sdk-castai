...
func NewNetworkConnectivityPolicyBasedRoute(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkConnectivityPolicyBasedRoute:NetworkConnectivityPolicyBasedRoute", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivityPolicyBasedRoute(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkConnectivityPolicyBasedRoute:NetworkConnectivityPolicyBasedRoute", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
