...
func NewGeminiRepositoryGroup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/geminiRepositoryGroup:GeminiRepositoryGroup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGeminiRepositoryGroup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/geminiRepositoryGroup:GeminiRepositoryGroup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
