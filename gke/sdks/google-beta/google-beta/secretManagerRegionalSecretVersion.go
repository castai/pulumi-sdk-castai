...
func NewSecretManagerRegionalSecretVersion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/secretManagerRegionalSecretVersion:SecretManagerRegionalSecretVersion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretManagerRegionalSecretVersion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/secretManagerRegionalSecretVersion:SecretManagerRegionalSecretVersion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
