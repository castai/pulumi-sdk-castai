...
func NewDataCatalogTag(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataCatalogTag:DataCatalogTag", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogTag(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataCatalogTag:DataCatalogTag", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
