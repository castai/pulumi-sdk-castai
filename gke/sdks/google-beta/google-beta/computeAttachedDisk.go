...
func NewComputeAttachedDisk(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeAttachedDisk:ComputeAttachedDisk", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeAttachedDisk(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeAttachedDisk:ComputeAttachedDisk", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
