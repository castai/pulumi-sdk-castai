...
func NewKmsKeyRingImportJob(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/kmsKeyRingImportJob:KmsKeyRingImportJob", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsKeyRingImportJob(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/kmsKeyRingImportJob:KmsKeyRingImportJob", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
