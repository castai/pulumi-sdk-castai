...
func NewCloudRunServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudRunServiceIamMember:CloudRunServiceIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudRunServiceIamMember:CloudRunServiceIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
