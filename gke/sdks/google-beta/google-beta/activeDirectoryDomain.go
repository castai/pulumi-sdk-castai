...
func NewActiveDirectoryDomain(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/activeDirectoryDomain:ActiveDirectoryDomain", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetActiveDirectoryDomain(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/activeDirectoryDomain:ActiveDirectoryDomain", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
