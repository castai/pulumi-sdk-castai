...
func NewBlockchainNodeEngineBlockchainNodes(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/blockchainNodeEngineBlockchainNodes:BlockchainNodeEngineBlockchainNodes", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBlockchainNodeEngineBlockchainNodes(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/blockchainNodeEngineBlockchainNodes:BlockchainNodeEngineBlockchainNodes", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
