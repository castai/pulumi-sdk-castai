...
type ContainerCluster struct {
	...
	ClusterTelemetry ContainerClusterClusterTelemetryPtrOutput `pulumi:"clusterTelemetry"`
	...
	PodSecurityPolicyConfig ContainerClusterPodSecurityPolicyConfigPtrOutput `pulumi:"podSecurityPolicyConfig"`
	...
	ProtectConfig ContainerClusterProtectConfigPtrOutput `pulumi:"protectConfig"`
	...
	TpuConfig ContainerClusterTpuConfigPtrOutput `pulumi:"tpuConfig"`
	...
	WorkloadAltsConfig ContainerClusterWorkloadAltsConfigPtrOutput `pulumi:"workloadAltsConfig"`
...
func NewContainerCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/containerCluster:ContainerCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/containerCluster:ContainerCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type containerClusterState struct {
	...
	// Telemetry integration for the cluster.
	ClusterTelemetry *ContainerClusterClusterTelemetry `pulumi:"clusterTelemetry"`
	// Configuration for the confidential nodes feature, which makes nodes run on confidential VMs. Warning: This configuration
	// can't be changed (or added/removed) after cluster creation without deleting and recreating the entire cluster.
	...
	// Configuration for the PodSecurityPolicy feature.
	PodSecurityPolicyConfig *ContainerClusterPodSecurityPolicyConfig `pulumi:"podSecurityPolicyConfig"`
	// Configuration for private clusters, clusters with private nodes.
	...
	// Enable/Disable Protect API features for the cluster.
	ProtectConfig *ContainerClusterProtectConfig `pulumi:"protectConfig"`
	// Configuration options for the Release channel feature, which provide more control over automatic upgrades of your GKE
	// clusters. Note that removing this field from your config will not unenroll it. Instead, use the "UNSPECIFIED" channel.
	...
	// TPU configuration for the cluster.
	TpuConfig *ContainerClusterTpuConfig `pulumi:"tpuConfig"`
	// The IP address range of the Cloud TPUs in this cluster, in CIDR notation (e.g. 1.2.3.4/29).
	...
	// Configuration for direct-path (via ALTS) with workload identity.
	WorkloadAltsConfig *ContainerClusterWorkloadAltsConfig `pulumi:"workloadAltsConfig"`
	// Configuration for the use of Kubernetes Service Accounts in GCP IAM policies.
...
type ContainerClusterState struct {
	...
	// Telemetry integration for the cluster.
	ClusterTelemetry ContainerClusterClusterTelemetryPtrInput
	// Configuration for the confidential nodes feature, which makes nodes run on confidential VMs. Warning: This configuration
	// can't be changed (or added/removed) after cluster creation without deleting and recreating the entire cluster.
	...
	// Configuration for the PodSecurityPolicy feature.
	PodSecurityPolicyConfig ContainerClusterPodSecurityPolicyConfigPtrInput
	// Configuration for private clusters, clusters with private nodes.
	...
	// Enable/Disable Protect API features for the cluster.
	ProtectConfig ContainerClusterProtectConfigPtrInput
	// Configuration options for the Release channel feature, which provide more control over automatic upgrades of your GKE
	// clusters. Note that removing this field from your config will not unenroll it. Instead, use the "UNSPECIFIED" channel.
	...
	// TPU configuration for the cluster.
	TpuConfig ContainerClusterTpuConfigPtrInput
	// The IP address range of the Cloud TPUs in this cluster, in CIDR notation (e.g. 1.2.3.4/29).
	...
	// Configuration for direct-path (via ALTS) with workload identity.
	WorkloadAltsConfig ContainerClusterWorkloadAltsConfigPtrInput
	// Configuration for the use of Kubernetes Service Accounts in GCP IAM policies.
...
// Telemetry integration for the cluster.
func (o ContainerClusterOutput) ClusterTelemetry() ContainerClusterClusterTelemetryPtrOutput {
	return o.ApplyT(func(v *ContainerCluster) ContainerClusterClusterTelemetryPtrOutput { return v.ClusterTelemetry }).(ContainerClusterClusterTelemetryPtrOutput)
}
...
// Whether to enable Cloud TPU resources in this cluster.
func (o ContainerClusterOutput) EnableTpu() pulumi.BoolOutput {
	return o.ApplyT(func(v *ContainerCluster) pulumi.BoolOutput { return v.EnableTpu }).(pulumi.BoolOutput)
}
...
// Configuration for the PodSecurityPolicy feature.
func (o ContainerClusterOutput) PodSecurityPolicyConfig() ContainerClusterPodSecurityPolicyConfigPtrOutput {
	return o.ApplyT(func(v *ContainerCluster) ContainerClusterPodSecurityPolicyConfigPtrOutput {
		return v.PodSecurityPolicyConfig
	}).(ContainerClusterPodSecurityPolicyConfigPtrOutput)
}
...
// Enable/Disable Protect API features for the cluster.
func (o ContainerClusterOutput) ProtectConfig() ContainerClusterProtectConfigPtrOutput {
	return o.ApplyT(func(v *ContainerCluster) ContainerClusterProtectConfigPtrOutput { return v.ProtectConfig }).(ContainerClusterProtectConfigPtrOutput)
}
...
// TPU configuration for the cluster.
func (o ContainerClusterOutput) TpuConfig() ContainerClusterTpuConfigPtrOutput {
	return o.ApplyT(func(v *ContainerCluster) ContainerClusterTpuConfigPtrOutput { return v.TpuConfig }).(ContainerClusterTpuConfigPtrOutput)
}
...
// Configuration for direct-path (via ALTS) with workload identity.
func (o ContainerClusterOutput) WorkloadAltsConfig() ContainerClusterWorkloadAltsConfigPtrOutput {
	return o.ApplyT(func(v *ContainerCluster) ContainerClusterWorkloadAltsConfigPtrOutput { return v.WorkloadAltsConfig }).(ContainerClusterWorkloadAltsConfigPtrOutput)
}
