...
func NewComputeTargetTcpProxy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeTargetTcpProxy:ComputeTargetTcpProxy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeTargetTcpProxy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeTargetTcpProxy:ComputeTargetTcpProxy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
