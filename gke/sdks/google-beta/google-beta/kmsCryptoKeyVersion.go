...
func NewKmsCryptoKeyVersion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/kmsCryptoKeyVersion:KmsCryptoKeyVersion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsCryptoKeyVersion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/kmsCryptoKeyVersion:KmsCryptoKeyVersion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
