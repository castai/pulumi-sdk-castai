...
func NewSqlDatabase(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sqlDatabase:SqlDatabase", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDatabase(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sqlDatabase:SqlDatabase", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
