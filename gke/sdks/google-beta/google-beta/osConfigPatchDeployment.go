...
func NewOsConfigPatchDeployment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/osConfigPatchDeployment:OsConfigPatchDeployment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOsConfigPatchDeployment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/osConfigPatchDeployment:OsConfigPatchDeployment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
