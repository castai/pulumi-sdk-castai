...
func NewLoggingOrganizationExclusion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingOrganizationExclusion:LoggingOrganizationExclusion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingOrganizationExclusion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingOrganizationExclusion:LoggingOrganizationExclusion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
