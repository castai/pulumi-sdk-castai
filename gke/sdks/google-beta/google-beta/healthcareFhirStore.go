...
func NewHealthcareFhirStore(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/healthcareFhirStore:HealthcareFhirStore", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareFhirStore(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/healthcareFhirStore:HealthcareFhirStore", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Whether to allow the ExecuteBundle API to accept history bundles, and directly insert and overwrite historical resource
// versions into the FHIR store. If set to false, using history bundles fails with an error.
func (o HealthcareFhirStoreOutput) EnableHistoryModifications() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *HealthcareFhirStore) pulumi.BoolPtrOutput { return v.EnableHistoryModifications }).(pulumi.BoolPtrOutput)
}
...
// The FHIR specification version. Default value: "STU3" Possible values: ["DSTU2", "STU3", "R4"]
func (o HealthcareFhirStoreOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HealthcareFhirStore) pulumi.StringPtrOutput { return v.Version }).(pulumi.StringPtrOutput)
}
