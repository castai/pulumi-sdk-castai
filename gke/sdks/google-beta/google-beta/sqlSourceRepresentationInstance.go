...
func NewSqlSourceRepresentationInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sqlSourceRepresentationInstance:SqlSourceRepresentationInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlSourceRepresentationInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sqlSourceRepresentationInstance:SqlSourceRepresentationInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
