...
func NewComputeRouterInterface(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeRouterInterface:ComputeRouterInterface", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRouterInterface(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeRouterInterface:ComputeRouterInterface", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
