...
func NewSccFolderNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccFolderNotificationConfig:SccFolderNotificationConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccFolderNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccFolderNotificationConfig:SccFolderNotificationConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
