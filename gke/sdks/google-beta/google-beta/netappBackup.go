...
func NewNetappBackup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/netappBackup:NetappBackup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappBackup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/netappBackup:NetappBackup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
