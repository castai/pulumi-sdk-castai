...
func NewLoggingFolderSink(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingFolderSink:LoggingFolderSink", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingFolderSink(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingFolderSink:LoggingFolderSink", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
