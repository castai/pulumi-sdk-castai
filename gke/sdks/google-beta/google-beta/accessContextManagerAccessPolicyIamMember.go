...
func NewAccessContextManagerAccessPolicyIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerAccessPolicyIamMember:AccessContextManagerAccessPolicyIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessPolicyIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerAccessPolicyIamMember:AccessContextManagerAccessPolicyIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
