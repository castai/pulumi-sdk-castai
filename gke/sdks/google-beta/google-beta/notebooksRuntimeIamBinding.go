...
func NewNotebooksRuntimeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/notebooksRuntimeIamBinding:NotebooksRuntimeIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksRuntimeIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/notebooksRuntimeIamBinding:NotebooksRuntimeIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
