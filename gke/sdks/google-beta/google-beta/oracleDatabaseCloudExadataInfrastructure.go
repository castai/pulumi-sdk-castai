...
func NewOracleDatabaseCloudExadataInfrastructure(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/oracleDatabaseCloudExadataInfrastructure:OracleDatabaseCloudExadataInfrastructure", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOracleDatabaseCloudExadataInfrastructure(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/oracleDatabaseCloudExadataInfrastructure:OracleDatabaseCloudExadataInfrastructure", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
