...
func NewComputeHttpHealthCheck(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeHttpHealthCheck:ComputeHttpHealthCheck", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeHttpHealthCheck(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeHttpHealthCheck:ComputeHttpHealthCheck", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
