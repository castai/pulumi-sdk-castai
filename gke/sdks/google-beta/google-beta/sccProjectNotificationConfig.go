...
func NewSccProjectNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccProjectNotificationConfig:SccProjectNotificationConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccProjectNotificationConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccProjectNotificationConfig:SccProjectNotificationConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
