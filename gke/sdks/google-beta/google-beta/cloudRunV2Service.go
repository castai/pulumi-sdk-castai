...
func NewCloudRunV2Service(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudRunV2Service:CloudRunV2Service", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunV2Service(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudRunV2Service:CloudRunV2Service", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Disables public resolution of the default URI of this service.
func (o CloudRunV2ServiceOutput) DefaultUriDisabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *CloudRunV2Service) pulumi.BoolPtrOutput { return v.DefaultUriDisabled }).(pulumi.BoolPtrOutput)
}
