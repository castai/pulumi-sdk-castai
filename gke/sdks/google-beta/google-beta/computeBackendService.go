...
func NewComputeBackendService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeBackendService:ComputeBackendService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeBackendService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeBackendService:ComputeBackendService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
