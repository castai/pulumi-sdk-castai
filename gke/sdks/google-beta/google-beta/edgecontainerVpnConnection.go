...
func NewEdgecontainerVpnConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/edgecontainerVpnConnection:EdgecontainerVpnConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEdgecontainerVpnConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/edgecontainerVpnConnection:EdgecontainerVpnConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
