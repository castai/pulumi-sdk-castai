...
type VertexAiFeatureOnlineStoreFeatureview struct {
	...
	VectorSearchConfig                      VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfigPtrOutput `pulumi:"vectorSearchConfig"`
...
func NewVertexAiFeatureOnlineStoreFeatureview(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vertexAiFeatureOnlineStoreFeatureview:VertexAiFeatureOnlineStoreFeatureview", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiFeatureOnlineStoreFeatureview(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vertexAiFeatureOnlineStoreFeatureview:VertexAiFeatureOnlineStoreFeatureview", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type vertexAiFeatureOnlineStoreFeatureviewState struct {
	...
	// Configuration for vector search. It contains the required configurations to create an index from source data, so that
	// approximate nearest neighbor (a.k.a ANN) algorithms search can be performed during online serving.
	VectorSearchConfig                      *VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfig `pulumi:"vectorSearchConfig"`
...
type VertexAiFeatureOnlineStoreFeatureviewState struct {
	...
	// Configuration for vector search. It contains the required configurations to create an index from source data, so that
	// approximate nearest neighbor (a.k.a ANN) algorithms search can be performed during online serving.
	VectorSearchConfig                      VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfigPtrInput
...
// Configuration for vector search. It contains the required configurations to create an index from source data, so that
// approximate nearest neighbor (a.k.a ANN) algorithms search can be performed during online serving.
func (o VertexAiFeatureOnlineStoreFeatureviewOutput) VectorSearchConfig() VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfigPtrOutput {
	return o.ApplyT(func(v *VertexAiFeatureOnlineStoreFeatureview) VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfigPtrOutput {
		return v.VectorSearchConfig
	}).(VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfigPtrOutput)
}
