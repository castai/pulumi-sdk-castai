...
func NewNotebooksLocation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/notebooksLocation:NotebooksLocation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksLocation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/notebooksLocation:NotebooksLocation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
