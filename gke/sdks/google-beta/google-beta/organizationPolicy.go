...
func NewOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/organizationPolicy:OrganizationPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/organizationPolicy:OrganizationPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
