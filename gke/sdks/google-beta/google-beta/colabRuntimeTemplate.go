...
func NewColabRuntimeTemplate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/colabRuntimeTemplate:ColabRuntimeTemplate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabRuntimeTemplate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/colabRuntimeTemplate:ColabRuntimeTemplate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
