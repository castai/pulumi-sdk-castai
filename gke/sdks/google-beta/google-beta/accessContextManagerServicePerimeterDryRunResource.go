...
func NewAccessContextManagerServicePerimeterDryRunResource(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerServicePerimeterDryRunResource:AccessContextManagerServicePerimeterDryRunResource", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerServicePerimeterDryRunResource(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerServicePerimeterDryRunResource:AccessContextManagerServicePerimeterDryRunResource", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
