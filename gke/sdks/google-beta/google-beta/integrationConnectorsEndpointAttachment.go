...
func NewIntegrationConnectorsEndpointAttachment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/integrationConnectorsEndpointAttachment:IntegrationConnectorsEndpointAttachment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationConnectorsEndpointAttachment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/integrationConnectorsEndpointAttachment:IntegrationConnectorsEndpointAttachment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
