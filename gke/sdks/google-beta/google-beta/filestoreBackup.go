...
func NewFilestoreBackup(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/filestoreBackup:FilestoreBackup", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFilestoreBackup(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/filestoreBackup:FilestoreBackup", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
