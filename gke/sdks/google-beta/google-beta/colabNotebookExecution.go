...
func NewColabNotebookExecution(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/colabNotebookExecution:ColabNotebookExecution", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabNotebookExecution(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/colabNotebookExecution:ColabNotebookExecution", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
