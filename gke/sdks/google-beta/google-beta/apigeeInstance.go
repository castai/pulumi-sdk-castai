...
func NewApigeeInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeInstance:ApigeeInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeInstance:ApigeeInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
