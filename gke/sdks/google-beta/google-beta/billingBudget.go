...
func NewBillingBudget(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/billingBudget:BillingBudget", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingBudget(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/billingBudget:BillingBudget", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
