...
func NewFirestoreField(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firestoreField:FirestoreField", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirestoreField(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firestoreField:FirestoreField", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
