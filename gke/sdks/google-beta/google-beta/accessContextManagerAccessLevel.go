...
func NewAccessContextManagerAccessLevel(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerAccessLevel:AccessContextManagerAccessLevel", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessLevel(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerAccessLevel:AccessContextManagerAccessLevel", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
