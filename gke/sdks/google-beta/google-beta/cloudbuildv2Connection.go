...
func NewCloudbuildv2Connection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudbuildv2Connection:Cloudbuildv2Connection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudbuildv2Connection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudbuildv2Connection:Cloudbuildv2Connection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
