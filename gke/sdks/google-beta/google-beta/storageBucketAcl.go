...
func NewStorageBucketAcl(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/storageBucketAcl:StorageBucketAcl", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageBucketAcl(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/storageBucketAcl:StorageBucketAcl", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
