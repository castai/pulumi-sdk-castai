...
func NewLoggingBillingAccountExclusion(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingBillingAccountExclusion:LoggingBillingAccountExclusion", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingBillingAccountExclusion(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingBillingAccountExclusion:LoggingBillingAccountExclusion", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
