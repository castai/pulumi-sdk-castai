...
func NewBigqueryAnalyticsHubListingIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryAnalyticsHubListingIamBinding:BigqueryAnalyticsHubListingIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubListingIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryAnalyticsHubListingIamBinding:BigqueryAnalyticsHubListingIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
