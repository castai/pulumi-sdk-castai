...
func NewComputeProjectMetadata(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeProjectMetadata:ComputeProjectMetadata", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeProjectMetadata(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeProjectMetadata:ComputeProjectMetadata", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
