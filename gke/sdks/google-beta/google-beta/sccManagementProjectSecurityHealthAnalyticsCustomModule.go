...
func NewSccManagementProjectSecurityHealthAnalyticsCustomModule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccManagementProjectSecurityHealthAnalyticsCustomModule:SccManagementProjectSecurityHealthAnalyticsCustomModule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccManagementProjectSecurityHealthAnalyticsCustomModule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccManagementProjectSecurityHealthAnalyticsCustomModule:SccManagementProjectSecurityHealthAnalyticsCustomModule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
