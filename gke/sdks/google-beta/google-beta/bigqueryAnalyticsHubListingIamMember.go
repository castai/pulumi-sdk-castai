...
func NewBigqueryAnalyticsHubListingIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryAnalyticsHubListingIamMember:BigqueryAnalyticsHubListingIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubListingIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryAnalyticsHubListingIamMember:BigqueryAnalyticsHubListingIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
