...
func NewProvider(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("pulumi:providers:google-beta", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type providerArgs struct {
	...
	Batchings                                 []ProviderBatching `pulumi:"batchings"`
...
type ProviderArgs struct {
	...
	Batchings                                 ProviderBatchingArrayInput
