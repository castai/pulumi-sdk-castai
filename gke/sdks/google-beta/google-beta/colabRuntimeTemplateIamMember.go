...
func NewColabRuntimeTemplateIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/colabRuntimeTemplateIamMember:ColabRuntimeTemplateIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabRuntimeTemplateIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/colabRuntimeTemplateIamMember:ColabRuntimeTemplateIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
