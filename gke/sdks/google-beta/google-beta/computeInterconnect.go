...
func NewComputeInterconnect(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeInterconnect:ComputeInterconnect", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeInterconnect(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeInterconnect:ComputeInterconnect", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
