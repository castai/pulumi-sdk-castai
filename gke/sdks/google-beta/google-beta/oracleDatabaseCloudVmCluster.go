...
func NewOracleDatabaseCloudVmCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/oracleDatabaseCloudVmCluster:OracleDatabaseCloudVmCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOracleDatabaseCloudVmCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/oracleDatabaseCloudVmCluster:OracleDatabaseCloudVmCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
