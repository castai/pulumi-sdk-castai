...
func NewCloudIdsEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudIdsEndpoint:CloudIdsEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudIdsEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudIdsEndpoint:CloudIdsEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
