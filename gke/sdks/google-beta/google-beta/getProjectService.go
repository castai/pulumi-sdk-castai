...
func LookupProjectService(ctx *pulumi.Context, args *LookupProjectServiceArgs, opts ...pulumi.InvokeOption) (*LookupProjectServiceResult, error) {
	...
	err = ctx.InvokePackage("google-beta:index/getProjectService:getProjectService", args, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupProjectServiceOutput(ctx *pulumi.Context, args LookupProjectServiceOutputArgs, opts ...pulumi.InvokeOption) LookupProjectServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupProjectServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("google-beta:index/getProjectService:getProjectService", args, LookupProjectServiceResultOutput{}, options).(LookupProjectServiceResultOutput), nil
...
func (o LookupProjectServiceResultOutput) CheckIfServiceHasUsageOnDestroy() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupProjectServiceResult) bool { return v.CheckIfServiceHasUsageOnDestroy }).(pulumi.BoolOutput)
}
