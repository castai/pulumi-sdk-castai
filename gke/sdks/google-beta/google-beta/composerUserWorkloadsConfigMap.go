...
func NewComposerUserWorkloadsConfigMap(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/composerUserWorkloadsConfigMap:ComposerUserWorkloadsConfigMap", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComposerUserWorkloadsConfigMap(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/composerUserWorkloadsConfigMap:ComposerUserWorkloadsConfigMap", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
