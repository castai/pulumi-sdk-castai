...
func NewPrivatecaCertificateAuthority(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/privatecaCertificateAuthority:PrivatecaCertificateAuthority", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivatecaCertificateAuthority(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/privatecaCertificateAuthority:PrivatecaCertificateAuthority", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
