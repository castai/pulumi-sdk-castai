...
func NewComputeNodeTemplate(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeNodeTemplate:ComputeNodeTemplate", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeNodeTemplate(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeNodeTemplate:ComputeNodeTemplate", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
