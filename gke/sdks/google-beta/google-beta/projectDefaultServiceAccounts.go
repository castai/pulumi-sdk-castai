...
func NewProjectDefaultServiceAccounts(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/projectDefaultServiceAccounts:ProjectDefaultServiceAccounts", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectDefaultServiceAccounts(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/projectDefaultServiceAccounts:ProjectDefaultServiceAccounts", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
