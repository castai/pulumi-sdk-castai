...
func NewCloudRunService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudRunService:CloudRunService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudRunService:CloudRunService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
