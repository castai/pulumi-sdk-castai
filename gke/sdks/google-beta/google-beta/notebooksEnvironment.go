...
func NewNotebooksEnvironment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/notebooksEnvironment:NotebooksEnvironment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotebooksEnvironment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/notebooksEnvironment:NotebooksEnvironment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
