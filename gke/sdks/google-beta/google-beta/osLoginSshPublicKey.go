...
func NewOsLoginSshPublicKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/osLoginSshPublicKey:OsLoginSshPublicKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOsLoginSshPublicKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/osLoginSshPublicKey:OsLoginSshPublicKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
