...
func NewDataprocBatch(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocBatch:DataprocBatch", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocBatch(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocBatch:DataprocBatch", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
