...
func NewHealthcareWorkspace(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/healthcareWorkspace:HealthcareWorkspace", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthcareWorkspace(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/healthcareWorkspace:HealthcareWorkspace", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
