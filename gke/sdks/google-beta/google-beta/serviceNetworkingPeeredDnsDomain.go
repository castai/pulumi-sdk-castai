...
func NewServiceNetworkingPeeredDnsDomain(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/serviceNetworkingPeeredDnsDomain:ServiceNetworkingPeeredDnsDomain", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceNetworkingPeeredDnsDomain(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/serviceNetworkingPeeredDnsDomain:ServiceNetworkingPeeredDnsDomain", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
