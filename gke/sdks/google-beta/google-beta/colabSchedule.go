...
func NewColabSchedule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/colabSchedule:ColabSchedule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabSchedule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/colabSchedule:ColabSchedule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
