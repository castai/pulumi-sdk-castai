...
func NewFirebaseAppCheckServiceConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firebaseAppCheckServiceConfig:FirebaseAppCheckServiceConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckServiceConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firebaseAppCheckServiceConfig:FirebaseAppCheckServiceConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
