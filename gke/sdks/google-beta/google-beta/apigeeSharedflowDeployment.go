...
func NewApigeeSharedflowDeployment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeSharedflowDeployment:ApigeeSharedflowDeployment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeSharedflowDeployment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeSharedflowDeployment:ApigeeSharedflowDeployment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
