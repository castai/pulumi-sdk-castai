...
type ContainerAzureCluster struct {
	...
	LoggingConfig ContainerAzureClusterLoggingConfigPtrOutput `pulumi:"loggingConfig"`
...
func NewContainerAzureCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/containerAzureCluster:ContainerAzureCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAzureCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/containerAzureCluster:ContainerAzureCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type containerAzureClusterState struct {
	...
	// Logging configuration.
	LoggingConfig *ContainerAzureClusterLoggingConfig `pulumi:"loggingConfig"`
	// The name of this resource.
...
type ContainerAzureClusterState struct {
	...
	// Logging configuration.
	LoggingConfig ContainerAzureClusterLoggingConfigPtrInput
	// The name of this resource.
...
// Logging configuration.
func (o ContainerAzureClusterOutput) LoggingConfig() ContainerAzureClusterLoggingConfigPtrOutput {
	return o.ApplyT(func(v *ContainerAzureCluster) ContainerAzureClusterLoggingConfigPtrOutput { return v.LoggingConfig }).(ContainerAzureClusterLoggingConfigPtrOutput)
}
