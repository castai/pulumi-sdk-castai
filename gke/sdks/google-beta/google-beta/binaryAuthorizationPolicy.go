...
func NewBinaryAuthorizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/binaryAuthorizationPolicy:BinaryAuthorizationPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBinaryAuthorizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/binaryAuthorizationPolicy:BinaryAuthorizationPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
