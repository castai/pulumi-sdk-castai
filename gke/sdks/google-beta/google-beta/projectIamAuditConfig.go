...
func NewProjectIamAuditConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/projectIamAuditConfig:ProjectIamAuditConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProjectIamAuditConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/projectIamAuditConfig:ProjectIamAuditConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
