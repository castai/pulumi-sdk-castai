...
func NewRedisCluster(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/redisCluster:RedisCluster", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisCluster(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/redisCluster:RedisCluster", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
