...
func NewResourceManagerLien(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/resourceManagerLien:ResourceManagerLien", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceManagerLien(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/resourceManagerLien:ResourceManagerLien", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
