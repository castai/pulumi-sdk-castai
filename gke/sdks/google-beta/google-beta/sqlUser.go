...
func NewSqlUser(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sqlUser:SqlUser", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlUser(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sqlUser:SqlUser", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
