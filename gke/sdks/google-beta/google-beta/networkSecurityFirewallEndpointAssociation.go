...
func NewNetworkSecurityFirewallEndpointAssociation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkSecurityFirewallEndpointAssociation:NetworkSecurityFirewallEndpointAssociation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkSecurityFirewallEndpointAssociation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkSecurityFirewallEndpointAssociation:NetworkSecurityFirewallEndpointAssociation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
