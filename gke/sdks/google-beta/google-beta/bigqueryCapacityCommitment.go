...
func NewBigqueryCapacityCommitment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryCapacityCommitment:BigqueryCapacityCommitment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryCapacityCommitment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryCapacityCommitment:BigqueryCapacityCommitment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
