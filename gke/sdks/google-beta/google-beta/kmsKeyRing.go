...
func NewKmsKeyRing(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/kmsKeyRing:KmsKeyRing", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKmsKeyRing(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/kmsKeyRing:KmsKeyRing", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
