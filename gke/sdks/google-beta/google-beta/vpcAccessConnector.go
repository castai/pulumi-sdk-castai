...
func NewVpcAccessConnector(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vpcAccessConnector:VpcAccessConnector", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcAccessConnector(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vpcAccessConnector:VpcAccessConnector", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
