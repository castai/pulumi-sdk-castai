...
func NewNetappKmsconfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/netappKmsconfig:NetappKmsconfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappKmsconfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/netappKmsconfig:NetappKmsconfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
