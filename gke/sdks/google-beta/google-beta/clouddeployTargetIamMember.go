...
func NewClouddeployTargetIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/clouddeployTargetIamMember:ClouddeployTargetIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddeployTargetIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/clouddeployTargetIamMember:ClouddeployTargetIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
