...
func NewMonitoringAlertPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/monitoringAlertPolicy:MonitoringAlertPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringAlertPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/monitoringAlertPolicy:MonitoringAlertPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
