...
func NewWorkflowsWorkflow(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/workflowsWorkflow:WorkflowsWorkflow", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkflowsWorkflow(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/workflowsWorkflow:WorkflowsWorkflow", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
