...
func NewVertexAiIndexEndpointDeployedIndex(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vertexAiIndexEndpointDeployedIndex:VertexAiIndexEndpointDeployedIndex", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVertexAiIndexEndpointDeployedIndex(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vertexAiIndexEndpointDeployedIndex:VertexAiIndexEndpointDeployedIndex", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
