...
func NewApigeeDeveloper(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeDeveloper:ApigeeDeveloper", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeDeveloper(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeDeveloper:ApigeeDeveloper", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
