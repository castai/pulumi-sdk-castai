...
func NewDataCatalogEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataCatalogEntryGroupIamPolicy:DataCatalogEntryGroupIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataCatalogEntryGroupIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataCatalogEntryGroupIamPolicy:DataCatalogEntryGroupIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
