...
func NewIamWorkforcePoolProvider(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/iamWorkforcePoolProvider:IamWorkforcePoolProvider", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamWorkforcePoolProvider(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/iamWorkforcePoolProvider:IamWorkforcePoolProvider", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
