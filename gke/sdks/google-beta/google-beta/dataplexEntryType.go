...
func NewDataplexEntryType(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataplexEntryType:DataplexEntryType", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataplexEntryType(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataplexEntryType:DataplexEntryType", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
