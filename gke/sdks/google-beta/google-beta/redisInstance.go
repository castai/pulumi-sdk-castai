...
func NewRedisInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/redisInstance:RedisInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedisInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/redisInstance:RedisInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
