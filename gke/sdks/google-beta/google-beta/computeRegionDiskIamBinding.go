...
func NewComputeRegionDiskIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeRegionDiskIamBinding:ComputeRegionDiskIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionDiskIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeRegionDiskIamBinding:ComputeRegionDiskIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
