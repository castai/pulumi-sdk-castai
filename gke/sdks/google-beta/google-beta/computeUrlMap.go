...
type ComputeUrlMap struct {
	...
	// defaultCustomErrorResponsePolicy specifies how the Load Balancer returns error responses when BackendService or
	...
	// Balancers.
	DefaultCustomErrorResponsePolicy ComputeUrlMapDefaultCustomErrorResponsePolicyPtrOutput `pulumi:"defaultCustomErrorResponsePolicy"`
...
func NewComputeUrlMap(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeUrlMap:ComputeUrlMap", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeUrlMap(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeUrlMap:ComputeUrlMap", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type computeUrlMapState struct {
	...
	// returned to the client. defaultCustomErrorResponsePolicy is supported only for global external Application Load
	// Balancers.
	DefaultCustomErrorResponsePolicy *ComputeUrlMapDefaultCustomErrorResponsePolicy `pulumi:"defaultCustomErrorResponsePolicy"`
	// defaultRouteAction takes effect when none of the hostRules match. The load balancer performs advanced routing actions
	// like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If
	// defaultRouteAction specifies any weightedBackendServices, defaultService must not be set. Conversely if defaultService
	// is set, defaultRouteAction cannot contain any weightedBackendServices. Only one of defaultRouteAction or
...
type ComputeUrlMapState struct {
	...
	// returned to the client. defaultCustomErrorResponsePolicy is supported only for global external Application Load
	// Balancers.
	DefaultCustomErrorResponsePolicy ComputeUrlMapDefaultCustomErrorResponsePolicyPtrInput
	// defaultRouteAction takes effect when none of the hostRules match. The load balancer performs advanced routing actions
	// like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If
	// defaultRouteAction specifies any weightedBackendServices, defaultService must not be set. Conversely if defaultService
	// is set, defaultRouteAction cannot contain any weightedBackendServices. Only one of defaultRouteAction or
...
// returned to the client. defaultCustomErrorResponsePolicy is supported only for global external Application Load
// Balancers.
func (o ComputeUrlMapOutput) DefaultCustomErrorResponsePolicy() ComputeUrlMapDefaultCustomErrorResponsePolicyPtrOutput {
	return o.ApplyT(func(v *ComputeUrlMap) ComputeUrlMapDefaultCustomErrorResponsePolicyPtrOutput {
		return v.DefaultCustomErrorResponsePolicy
	}).(ComputeUrlMapDefaultCustomErrorResponsePolicyPtrOutput)
}
