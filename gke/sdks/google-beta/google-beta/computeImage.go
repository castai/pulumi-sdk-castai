...
func NewComputeImage(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeImage:ComputeImage", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeImage(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeImage:ComputeImage", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
