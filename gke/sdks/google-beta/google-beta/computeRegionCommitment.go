...
func NewComputeRegionCommitment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeRegionCommitment:ComputeRegionCommitment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionCommitment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeRegionCommitment:ComputeRegionCommitment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
