...
func NewContainerAwsNodePool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/containerAwsNodePool:ContainerAwsNodePool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerAwsNodePool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/containerAwsNodePool:ContainerAwsNodePool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
