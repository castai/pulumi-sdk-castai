...
func NewSqlDatabaseInstance(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sqlDatabaseInstance:SqlDatabaseInstance", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSqlDatabaseInstance(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sqlDatabaseInstance:SqlDatabaseInstance", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
