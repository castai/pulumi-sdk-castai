...
func NewComputeDiskIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeDiskIamMember:ComputeDiskIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeDiskIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeDiskIamMember:ComputeDiskIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
