...
func NewFirebaseAppCheckRecaptchaEnterpriseConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firebaseAppCheckRecaptchaEnterpriseConfig:FirebaseAppCheckRecaptchaEnterpriseConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckRecaptchaEnterpriseConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firebaseAppCheckRecaptchaEnterpriseConfig:FirebaseAppCheckRecaptchaEnterpriseConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
