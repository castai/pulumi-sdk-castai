...
func NewCloudRunV2Job(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudRunV2Job:CloudRunV2Job", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudRunV2Job(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudRunV2Job:CloudRunV2Job", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// A unique string used as a suffix creating a new execution upon job create or update. The Job will become ready when the
// execution is successfully completed. The sum of job name and token length must be fewer than 63 characters.
func (o CloudRunV2JobOutput) RunExecutionToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CloudRunV2Job) pulumi.StringPtrOutput { return v.RunExecutionToken }).(pulumi.StringPtrOutput)
}

// A unique string used as a suffix creating a new execution upon job create or update. The Job will become ready when the
// execution is successfully started. The sum of job name and token length must be fewer than 63 characters.
func (o CloudRunV2JobOutput) StartExecutionToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CloudRunV2Job) pulumi.StringPtrOutput { return v.StartExecutionToken }).(pulumi.StringPtrOutput)
}
