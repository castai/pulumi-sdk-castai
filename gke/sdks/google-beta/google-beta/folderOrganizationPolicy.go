...
func NewFolderOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/folderOrganizationPolicy:FolderOrganizationPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFolderOrganizationPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/folderOrganizationPolicy:FolderOrganizationPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
