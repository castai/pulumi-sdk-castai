...
func NewDeploymentManagerDeployment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/deploymentManagerDeployment:DeploymentManagerDeployment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentManagerDeployment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/deploymentManagerDeployment:DeploymentManagerDeployment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
