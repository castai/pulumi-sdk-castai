...
func NewVmwareengineNetworkPeering(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vmwareengineNetworkPeering:VmwareengineNetworkPeering", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareengineNetworkPeering(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vmwareengineNetworkPeering:VmwareengineNetworkPeering", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
