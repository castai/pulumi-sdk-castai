...
func NewGkeHubMembership(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/gkeHubMembership:GkeHubMembership", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGkeHubMembership(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/gkeHubMembership:GkeHubMembership", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
//
// Deprecated: Deprecated
func (o GkeHubMembershipOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GkeHubMembership) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}
