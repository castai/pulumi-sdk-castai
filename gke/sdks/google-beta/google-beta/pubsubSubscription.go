...
func NewPubsubSubscription(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/pubsubSubscription:PubsubSubscription", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubSubscription(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/pubsubSubscription:PubsubSubscription", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
