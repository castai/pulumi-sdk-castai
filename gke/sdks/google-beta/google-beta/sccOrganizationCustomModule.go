...
func NewSccOrganizationCustomModule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccOrganizationCustomModule:SccOrganizationCustomModule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccOrganizationCustomModule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccOrganizationCustomModule:SccOrganizationCustomModule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
