...
type BigqueryTable struct {
	...
	ExternalCatalogTableOptions BigqueryTableExternalCatalogTableOptionsPtrOutput `pulumi:"externalCatalogTableOptions"`
	...
	SchemaForeignTypeInfo BigqueryTableSchemaForeignTypeInfoPtrOutput `pulumi:"schemaForeignTypeInfo"`
...
func NewBigqueryTable(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryTable:BigqueryTable", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryTable(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryTable:BigqueryTable", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type bigqueryTableState struct {
	...
	// Options defining open source compatible table.
	ExternalCatalogTableOptions *BigqueryTableExternalCatalogTableOptions `pulumi:"externalCatalogTableOptions"`
	// Describes the data format, location, and other properties of a table stored outside of BigQuery. By defining these
	// properties, the data source can then be queried as if it were a standard BigQuery table.
	...
	// Specifies metadata of the foreign data type definition in field schema.
	SchemaForeignTypeInfo *BigqueryTableSchemaForeignTypeInfo `pulumi:"schemaForeignTypeInfo"`
	// The URI of the created resource.
...
type BigqueryTableState struct {
	...
	// Options defining open source compatible table.
	ExternalCatalogTableOptions BigqueryTableExternalCatalogTableOptionsPtrInput
	// Describes the data format, location, and other properties of a table stored outside of BigQuery. By defining these
	// properties, the data source can then be queried as if it were a standard BigQuery table.
	...
	// Specifies metadata of the foreign data type definition in field schema.
	SchemaForeignTypeInfo BigqueryTableSchemaForeignTypeInfoPtrInput
	// The URI of the created resource.
...
// Options defining open source compatible table.
func (o BigqueryTableOutput) ExternalCatalogTableOptions() BigqueryTableExternalCatalogTableOptionsPtrOutput {
	return o.ApplyT(func(v *BigqueryTable) BigqueryTableExternalCatalogTableOptionsPtrOutput {
		return v.ExternalCatalogTableOptions
	}).(BigqueryTableExternalCatalogTableOptionsPtrOutput)
}
...
// Specifies metadata of the foreign data type definition in field schema.
func (o BigqueryTableOutput) SchemaForeignTypeInfo() BigqueryTableSchemaForeignTypeInfoPtrOutput {
	return o.ApplyT(func(v *BigqueryTable) BigqueryTableSchemaForeignTypeInfoPtrOutput { return v.SchemaForeignTypeInfo }).(BigqueryTableSchemaForeignTypeInfoPtrOutput)
}
