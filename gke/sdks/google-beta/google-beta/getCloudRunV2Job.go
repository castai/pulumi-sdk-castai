...
func LookupCloudRunV2Job(ctx *pulumi.Context, args *LookupCloudRunV2JobArgs, opts ...pulumi.InvokeOption) (*LookupCloudRunV2JobResult, error) {
	...
	err = ctx.InvokePackage("google-beta:index/getCloudRunV2Job:getCloudRunV2Job", args, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCloudRunV2JobOutput(ctx *pulumi.Context, args LookupCloudRunV2JobOutputArgs, opts ...pulumi.InvokeOption) LookupCloudRunV2JobResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCloudRunV2JobResultOutput, error) {
			...
			return ctx.InvokeOutput("google-beta:index/getCloudRunV2Job:getCloudRunV2Job", args, LookupCloudRunV2JobResultOutput{}, options).(LookupCloudRunV2JobResultOutput), nil
...
func (o LookupCloudRunV2JobResultOutput) RunExecutionToken() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCloudRunV2JobResult) string { return v.RunExecutionToken }).(pulumi.StringOutput)
}

func (o LookupCloudRunV2JobResultOutput) StartExecutionToken() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCloudRunV2JobResult) string { return v.StartExecutionToken }).(pulumi.StringOutput)
}
