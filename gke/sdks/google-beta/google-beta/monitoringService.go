...
func NewMonitoringService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/monitoringService:MonitoringService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitoringService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/monitoringService:MonitoringService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
