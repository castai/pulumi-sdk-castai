...
func NewDataprocAutoscalingPolicyIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocAutoscalingPolicyIamPolicy:DataprocAutoscalingPolicyIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocAutoscalingPolicyIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocAutoscalingPolicyIamPolicy:DataprocAutoscalingPolicyIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
