...
func NewColabRuntime(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/colabRuntime:ColabRuntime", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetColabRuntime(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/colabRuntime:ColabRuntime", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
