...
func NewDialogflowCxIntent(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dialogflowCxIntent:DialogflowCxIntent", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxIntent(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dialogflowCxIntent:DialogflowCxIntent", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
