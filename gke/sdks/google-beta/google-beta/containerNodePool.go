...
func NewContainerNodePool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/containerNodePool:ContainerNodePool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContainerNodePool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/containerNodePool:ContainerNodePool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
