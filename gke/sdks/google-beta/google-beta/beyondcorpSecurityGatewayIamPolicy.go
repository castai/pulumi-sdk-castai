...
func NewBeyondcorpSecurityGatewayIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/beyondcorpSecurityGatewayIamPolicy:BeyondcorpSecurityGatewayIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpSecurityGatewayIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/beyondcorpSecurityGatewayIamPolicy:BeyondcorpSecurityGatewayIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
