...
func NewSccV2FolderSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/sccV2FolderSccBigQueryExport:SccV2FolderSccBigQueryExport", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSccV2FolderSccBigQueryExport(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/sccV2FolderSccBigQueryExport:SccV2FolderSccBigQueryExport", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
