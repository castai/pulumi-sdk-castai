...
func NewComputeProjectMetadataItem(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeProjectMetadataItem:ComputeProjectMetadataItem", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeProjectMetadataItem(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeProjectMetadataItem:ComputeProjectMetadataItem", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
