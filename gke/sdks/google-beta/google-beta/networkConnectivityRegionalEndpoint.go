...
func NewNetworkConnectivityRegionalEndpoint(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkConnectivityRegionalEndpoint:NetworkConnectivityRegionalEndpoint", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkConnectivityRegionalEndpoint(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkConnectivityRegionalEndpoint:NetworkConnectivityRegionalEndpoint", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
