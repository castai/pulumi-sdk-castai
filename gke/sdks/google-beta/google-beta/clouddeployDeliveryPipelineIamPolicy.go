...
func NewClouddeployDeliveryPipelineIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/clouddeployDeliveryPipelineIamPolicy:ClouddeployDeliveryPipelineIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClouddeployDeliveryPipelineIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/clouddeployDeliveryPipelineIamPolicy:ClouddeployDeliveryPipelineIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
