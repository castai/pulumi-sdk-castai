...
func NewComputeBackendBucketSignedUrlKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeBackendBucketSignedUrlKey:ComputeBackendBucketSignedUrlKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeBackendBucketSignedUrlKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeBackendBucketSignedUrlKey:ComputeBackendBucketSignedUrlKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
