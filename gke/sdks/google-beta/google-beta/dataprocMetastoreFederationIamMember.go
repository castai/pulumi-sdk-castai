...
func NewDataprocMetastoreFederationIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocMetastoreFederationIamMember:DataprocMetastoreFederationIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocMetastoreFederationIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocMetastoreFederationIamMember:DataprocMetastoreFederationIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
