...
func NewFirestoreDatabase(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firestoreDatabase:FirestoreDatabase", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirestoreDatabase(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firestoreDatabase:FirestoreDatabase", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
