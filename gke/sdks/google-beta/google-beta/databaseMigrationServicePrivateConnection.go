...
func NewDatabaseMigrationServicePrivateConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/databaseMigrationServicePrivateConnection:DatabaseMigrationServicePrivateConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatabaseMigrationServicePrivateConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/databaseMigrationServicePrivateConnection:DatabaseMigrationServicePrivateConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
