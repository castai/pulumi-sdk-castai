...
func NewStorageManagedFolder(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/storageManagedFolder:StorageManagedFolder", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageManagedFolder(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/storageManagedFolder:StorageManagedFolder", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
