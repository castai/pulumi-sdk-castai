...
func NewPubsubSchema(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/pubsubSchema:PubsubSchema", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubSchema(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/pubsubSchema:PubsubSchema", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
