...
func NewAccessContextManagerAccessLevelCondition(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/accessContextManagerAccessLevelCondition:AccessContextManagerAccessLevelCondition", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessContextManagerAccessLevelCondition(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/accessContextManagerAccessLevelCondition:AccessContextManagerAccessLevelCondition", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
