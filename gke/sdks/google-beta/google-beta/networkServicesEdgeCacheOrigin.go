...
func NewNetworkServicesEdgeCacheOrigin(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkServicesEdgeCacheOrigin:NetworkServicesEdgeCacheOrigin", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServicesEdgeCacheOrigin(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkServicesEdgeCacheOrigin:NetworkServicesEdgeCacheOrigin", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
