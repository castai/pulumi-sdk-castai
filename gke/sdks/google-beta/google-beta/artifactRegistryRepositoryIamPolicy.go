...
func NewArtifactRegistryRepositoryIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/artifactRegistryRepositoryIamPolicy:ArtifactRegistryRepositoryIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArtifactRegistryRepositoryIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/artifactRegistryRepositoryIamPolicy:ArtifactRegistryRepositoryIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
