...
func NewCloudTasksQueue(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudTasksQueue:CloudTasksQueue", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudTasksQueue(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudTasksQueue:CloudTasksQueue", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
