...
func NewApigeeTargetServer(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeTargetServer:ApigeeTargetServer", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeTargetServer(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeTargetServer:ApigeeTargetServer", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
