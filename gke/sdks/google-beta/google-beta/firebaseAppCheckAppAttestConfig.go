...
func NewFirebaseAppCheckAppAttestConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/firebaseAppCheckAppAttestConfig:FirebaseAppCheckAppAttestConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFirebaseAppCheckAppAttestConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/firebaseAppCheckAppAttestConfig:FirebaseAppCheckAppAttestConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
