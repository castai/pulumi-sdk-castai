...
func NewBeyondcorpAppConnector(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/beyondcorpAppConnector:BeyondcorpAppConnector", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpAppConnector(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/beyondcorpAppConnector:BeyondcorpAppConnector", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
