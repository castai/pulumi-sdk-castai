...
func NewBigqueryDatapolicyDataPolicyIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryDatapolicyDataPolicyIamMember:BigqueryDatapolicyDataPolicyIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryDatapolicyDataPolicyIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryDatapolicyDataPolicyIamMember:BigqueryDatapolicyDataPolicyIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
