...
func NewDialogflowEntityType(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dialogflowEntityType:DialogflowEntityType", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowEntityType(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dialogflowEntityType:DialogflowEntityType", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
