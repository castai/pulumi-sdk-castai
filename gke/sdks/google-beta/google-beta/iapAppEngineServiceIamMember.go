...
func NewIapAppEngineServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/iapAppEngineServiceIamMember:IapAppEngineServiceIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIapAppEngineServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/iapAppEngineServiceIamMember:IapAppEngineServiceIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
