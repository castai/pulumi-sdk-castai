...
func NewAppEngineFirewallRule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/appEngineFirewallRule:AppEngineFirewallRule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAppEngineFirewallRule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/appEngineFirewallRule:AppEngineFirewallRule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
