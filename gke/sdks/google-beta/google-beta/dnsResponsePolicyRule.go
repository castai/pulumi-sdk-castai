...
func NewDnsResponsePolicyRule(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dnsResponsePolicyRule:DnsResponsePolicyRule", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnsResponsePolicyRule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dnsResponsePolicyRule:DnsResponsePolicyRule", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Answer this query with a behavior rather than DNS data. Acceptable values are 'behaviorUnspecified', and
// 'bypassResponsePolicy'
func (o DnsResponsePolicyRuleOutput) Behavior() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DnsResponsePolicyRule) pulumi.StringPtrOutput { return v.Behavior }).(pulumi.StringPtrOutput)
}
