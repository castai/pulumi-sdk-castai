...
func NewDatastreamPrivateConnection(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/datastreamPrivateConnection:DatastreamPrivateConnection", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatastreamPrivateConnection(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/datastreamPrivateConnection:DatastreamPrivateConnection", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
