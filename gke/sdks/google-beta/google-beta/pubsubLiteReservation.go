...
func NewPubsubLiteReservation(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/pubsubLiteReservation:PubsubLiteReservation", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubLiteReservation(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/pubsubLiteReservation:PubsubLiteReservation", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
