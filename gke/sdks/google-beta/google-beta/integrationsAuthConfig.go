...
func NewIntegrationsAuthConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/integrationsAuthConfig:IntegrationsAuthConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationsAuthConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/integrationsAuthConfig:IntegrationsAuthConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
