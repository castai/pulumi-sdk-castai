...
func NewComputeInstanceGroupNamedPort(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeInstanceGroupNamedPort:ComputeInstanceGroupNamedPort", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeInstanceGroupNamedPort(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeInstanceGroupNamedPort:ComputeInstanceGroupNamedPort", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
