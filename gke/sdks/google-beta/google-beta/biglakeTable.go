...
func NewBiglakeTable(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/biglakeTable:BiglakeTable", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBiglakeTable(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/biglakeTable:BiglakeTable", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
