...
func NewBigqueryAnalyticsHubListingSubscription(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/bigqueryAnalyticsHubListingSubscription:BigqueryAnalyticsHubListingSubscription", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBigqueryAnalyticsHubListingSubscription(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/bigqueryAnalyticsHubListingSubscription:BigqueryAnalyticsHubListingSubscription", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
