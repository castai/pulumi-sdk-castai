...
func NewNetappVolumeReplication(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/netappVolumeReplication:NetappVolumeReplication", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappVolumeReplication(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/netappVolumeReplication:NetappVolumeReplication", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
