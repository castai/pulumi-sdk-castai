...
func NewCertificateManagerCertificateIssuanceConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/certificateManagerCertificateIssuanceConfig:CertificateManagerCertificateIssuanceConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateManagerCertificateIssuanceConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/certificateManagerCertificateIssuanceConfig:CertificateManagerCertificateIssuanceConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
