...
func NewVmwareenginePrivateCloud(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/vmwareenginePrivateCloud:VmwareenginePrivateCloud", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVmwareenginePrivateCloud(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/vmwareenginePrivateCloud:VmwareenginePrivateCloud", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
