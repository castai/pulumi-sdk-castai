...
func NewBiglakeCatalog(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/biglakeCatalog:BiglakeCatalog", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBiglakeCatalog(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/biglakeCatalog:BiglakeCatalog", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
