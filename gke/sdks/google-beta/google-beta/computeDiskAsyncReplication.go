...
func NewComputeDiskAsyncReplication(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeDiskAsyncReplication:ComputeDiskAsyncReplication", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeDiskAsyncReplication(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeDiskAsyncReplication:ComputeDiskAsyncReplication", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
