...
func NewDialogflowCxFlow(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dialogflowCxFlow:DialogflowCxFlow", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDialogflowCxFlow(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dialogflowCxFlow:DialogflowCxFlow", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
