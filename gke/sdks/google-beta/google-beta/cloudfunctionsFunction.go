...
func NewCloudfunctionsFunction(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudfunctionsFunction:CloudfunctionsFunction", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudfunctionsFunction(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudfunctionsFunction:CloudfunctionsFunction", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
