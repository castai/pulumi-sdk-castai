...
func NewPrivatecaCaPool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/privatecaCaPool:PrivatecaCaPool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivatecaCaPool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/privatecaCaPool:PrivatecaCaPool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
