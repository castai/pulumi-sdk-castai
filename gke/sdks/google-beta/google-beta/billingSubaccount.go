...
func NewBillingSubaccount(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/billingSubaccount:BillingSubaccount", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBillingSubaccount(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/billingSubaccount:BillingSubaccount", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
