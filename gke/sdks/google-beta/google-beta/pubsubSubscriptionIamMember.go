...
func NewPubsubSubscriptionIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/pubsubSubscriptionIamMember:PubsubSubscriptionIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPubsubSubscriptionIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/pubsubSubscriptionIamMember:PubsubSubscriptionIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
