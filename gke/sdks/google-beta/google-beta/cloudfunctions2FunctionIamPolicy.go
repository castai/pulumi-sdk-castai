...
func NewCloudfunctions2FunctionIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/cloudfunctions2FunctionIamPolicy:Cloudfunctions2FunctionIamPolicy", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCloudfunctions2FunctionIamPolicy(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/cloudfunctions2FunctionIamPolicy:Cloudfunctions2FunctionIamPolicy", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
