...
func NewNetworkServicesEdgeCacheService(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/networkServicesEdgeCacheService:NetworkServicesEdgeCacheService", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkServicesEdgeCacheService(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/networkServicesEdgeCacheService:NetworkServicesEdgeCacheService", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
