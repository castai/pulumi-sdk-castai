...
func NewBeyondcorpApplication(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/beyondcorpApplication:BeyondcorpApplication", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBeyondcorpApplication(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/beyondcorpApplication:BeyondcorpApplication", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
