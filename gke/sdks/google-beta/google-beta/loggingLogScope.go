...
func NewLoggingLogScope(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/loggingLogScope:LoggingLogScope", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingLogScope(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/loggingLogScope:LoggingLogScope", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
