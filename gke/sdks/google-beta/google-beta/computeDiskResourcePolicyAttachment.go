...
func NewComputeDiskResourcePolicyAttachment(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeDiskResourcePolicyAttachment:ComputeDiskResourcePolicyAttachment", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeDiskResourcePolicyAttachment(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeDiskResourcePolicyAttachment:ComputeDiskResourcePolicyAttachment", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
