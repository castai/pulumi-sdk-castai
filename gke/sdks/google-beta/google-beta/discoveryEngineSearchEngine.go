...
func NewDiscoveryEngineSearchEngine(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/discoveryEngineSearchEngine:DiscoveryEngineSearchEngine", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDiscoveryEngineSearchEngine(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/discoveryEngineSearchEngine:DiscoveryEngineSearchEngine", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
