...
func NewApigeeEnvironmentIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/apigeeEnvironmentIamMember:ApigeeEnvironmentIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApigeeEnvironmentIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/apigeeEnvironmentIamMember:ApigeeEnvironmentIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
