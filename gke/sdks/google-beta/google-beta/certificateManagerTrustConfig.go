...
func NewCertificateManagerTrustConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/certificateManagerTrustConfig:CertificateManagerTrustConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCertificateManagerTrustConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/certificateManagerTrustConfig:CertificateManagerTrustConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
