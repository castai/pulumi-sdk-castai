...
func NewStorageBucketObject(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/storageBucketObject:StorageBucketObject", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStorageBucketObject(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/storageBucketObject:StorageBucketObject", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
