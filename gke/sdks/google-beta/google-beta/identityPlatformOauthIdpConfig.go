...
func NewIdentityPlatformOauthIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/identityPlatformOauthIdpConfig:IdentityPlatformOauthIdpConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentityPlatformOauthIdpConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/identityPlatformOauthIdpConfig:IdentityPlatformOauthIdpConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
