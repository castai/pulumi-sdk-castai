...
func NewNetappStoragePool(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/netappStoragePool:NetappStoragePool", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetappStoragePool(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/netappStoragePool:NetappStoragePool", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
