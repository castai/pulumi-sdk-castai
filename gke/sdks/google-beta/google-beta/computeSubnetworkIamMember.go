...
func NewComputeSubnetworkIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeSubnetworkIamMember:ComputeSubnetworkIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSubnetworkIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeSubnetworkIamMember:ComputeSubnetworkIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
