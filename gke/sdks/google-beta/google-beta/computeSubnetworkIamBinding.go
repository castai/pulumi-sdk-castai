...
func NewComputeSubnetworkIamBinding(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeSubnetworkIamBinding:ComputeSubnetworkIamBinding", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeSubnetworkIamBinding(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeSubnetworkIamBinding:ComputeSubnetworkIamBinding", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
