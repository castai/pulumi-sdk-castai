...
func NewIntegrationsClient(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/integrationsClient:IntegrationsClient", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegrationsClient(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/integrationsClient:IntegrationsClient", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
