...
func NewRecaptchaEnterpriseKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/recaptchaEnterpriseKey:RecaptchaEnterpriseKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRecaptchaEnterpriseKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/recaptchaEnterpriseKey:RecaptchaEnterpriseKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
