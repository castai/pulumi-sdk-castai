...
func NewDataprocMetastoreServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/dataprocMetastoreServiceIamMember:DataprocMetastoreServiceIamMember", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataprocMetastoreServiceIamMember(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/dataprocMetastoreServiceIamMember:DataprocMetastoreServiceIamMember", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
