...
func NewIamWorkloadIdentityPoolProvider(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/iamWorkloadIdentityPoolProvider:IamWorkloadIdentityPoolProvider", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIamWorkloadIdentityPoolProvider(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/iamWorkloadIdentityPoolProvider:IamWorkloadIdentityPoolProvider", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
