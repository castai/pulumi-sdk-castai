...
func NewComputeRegionPerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeRegionPerInstanceConfig:ComputeRegionPerInstanceConfig", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeRegionPerInstanceConfig(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeRegionPerInstanceConfig:ComputeRegionPerInstanceConfig", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
