...
func NewComputeBackendServiceSignedUrlKey(ctx *pulumi.Context,
	...
	err = ctx.RegisterPackageResource("google-beta:index/computeBackendServiceSignedUrlKey:ComputeBackendServiceSignedUrlKey", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetComputeBackendServiceSignedUrlKey(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("google-beta:index/computeBackendServiceSignedUrlKey:ComputeBackendServiceSignedUrlKey", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
