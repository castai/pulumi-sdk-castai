...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/pulumi/pulumi-terraform-provider/sdks/go/castai/v7/castai(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Nhc3RhaS9jYXN0YWkiLCJ2ZXJzaW9uIjoiNy4zNi4wIn19")
		if err != nil {
			return "", err
		}
